...
namespace GadrocsWorkshop.Helios.Gauges.M2000C.Accelerometer
{
    ...
    using GadrocsWorkshop.Helios.Gauges.M2000C.Clock;
    using System;
    ...
    class Accelerometer : CompositeVisualWithBackgroundImage
    {
        ...
        private AccelerometerGauge _gauge;
        ...
        public Accelerometer()
            : base("Accelerometer", new Size(300, 300))
        {
            ...
            AddGauge("Accelerometer", new Point(0d, 0d), new Size(300d, 300d), _interfaceDeviceName, "Accelerometer");
        ...
        {
            _gauge = new AccelerometerGauge(name, size, _interfaceDeviceName, new string[3] { "Accelerometer g", "Accelerometer g Low", "Accelerometer g High" })
            {
                Top = pos.Y,
                Left = pos.X,
                Height = size.Height,
