...
namespace GadrocsWorkshop.Helios.Gauges.M2000C.TACAN
{
    ...
    class M2000C_TacanPanel : M2000CDevice
    {
            ...
            : base("TACAN Panel", new Size(350, 312))
        {
            ...
            AddDrum("Channel output for display (Ones)", "{M2000C}/Gauges/TACANPanel/drum_tape.xaml", "ones frequency", "(0 - 9)", "#", 
                new Point(210, 60), new Size(10d, 15d), new Size(33d, 52d));
            AddDrum("Channel output for display (Tens)", "{M2000C}/Gauges/TACANPanel/drum_tape_twelve.xaml", "tens frequency", "(0 - 12)", "#", 
