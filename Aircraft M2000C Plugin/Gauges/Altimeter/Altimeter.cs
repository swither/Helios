...
namespace GadrocsWorkshop.Helios.Gauges.M2000C.Altimeter
{
    ...
    public class Altimeter : BaseGauge
    {
        ...
        {
            Components.Add(new GaugeImage("{M2000C}/Gauges/Altimeter/altimeter_backplate.xaml", new Rect(32d, 38d, 300d, 300d)));

            _tenThousandsDrum = new GaugeDrumCounter("{M2000C}/Gauges/Altimeter/alt_drum_tape.xaml", new Point(98d, 126d), "#", new Size(13d, 15d), new Size(30d, 44d));
            ...
            Components.Add(new GaugeImage("{M2000C}/Gauges/Altimeter/altimeter_faceplate.xaml", new Rect(32d, 38d, 300d, 300d)));
            ...
            _needle = new GaugeNeedle("{M2000C}/Gauges/Altimeter/altimeter_needle.xaml", new Point(182d, 188d), new Size(14d, 178d), new Point(7d, 115d));
