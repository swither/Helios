...
namespace GadrocsWorkshop.Helios.Gauges.M2000C
{
    ...
    class RADARIFFMode : M2000CDevice
    {
            ...
            : base("RADAR IFF Mode Panel", new Size(600, 186))
        {
            ...
            AddDrum("Radar IFF Code-4 Drum", "{M2000C}/Gauges/Common/drum_tape.xaml", "Radar IFF Code-4 Drum", "(0-9)", "#", new Point(212, 75), new Size(10, 15), new Size(18, 23));
            AddRotarySwitch("Radar IFF Code-3 Selector", new Point(259, 47), new Size(40, 84), 10);
            AddDrum("Radar IFF Code-3 Drum", "{M2000C}/Gauges/Common/drum_tape.xaml", "Radar IFF Code-3 Drum", "(0-9)", "#", new Point(264, 75), new Size(10, 15), new Size(18, 23));
            AddRotarySwitch("Radar IFF Code-2 Selector", new Point(315, 47), new Size(40, 84), 10);
            AddDrum("Radar IFF Code-2 Drum", "{M2000C}/Gauges/Common/drum_tape.xaml", "Radar IFF Code-2 Drum", "(0-9)", "#", new Point(319, 75), new Size(10, 15), new Size(18, 23));
            AddRotarySwitch("Radar IFF Code-1 Selector", new Point(367, 47), new Size(40, 84), 10);
            AddDrum("Radar IFF Code-1 Drum", "{M2000C}/Gauges/Common/drum_tape.xaml", "Radar IFF Code-1 Drum", "(0-9)", "#", new Point(370, 75), new Size(10, 15), new Size(18, 23));
