...
namespace GadrocsWorkshop.Helios.Gauges.M2000C
{
    ...
    class Fuel_Burn_Bingo : M2000CDevice
    {
            ...
            : base("Fuel Burn / Bingo Panel", new Size(140, 172))
        {
            ...
            AddDrum("Bingo Fuel 1 000 kg Drum", "{M2000C}/Gauges/Common/drum_tape.xaml", "Bingo Fuel 1 000 kg Drum", "(0-3)", "#", new Point(24, 104), new Size(10, 15), new Size(12, 19)); 
            AddRotarySwitch("Bingo Fuel 100 kg Selector", new Point(62, 52), new Size(58, 120), 10);
            AddDrum("Bingo Fuel 100 kg Drum", "{M2000C}/Gauges/Common/drum_tape.xaml", "Bingo Fuel 100 kg Drum", "(0-9)", "#", new Point(65, 104), new Size(10, 15), new Size(12, 19));
