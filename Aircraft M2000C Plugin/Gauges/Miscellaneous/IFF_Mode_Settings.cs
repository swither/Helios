...
namespace GadrocsWorkshop.Helios.Gauges.M2000C
{
    ...
    class IFFMode : M2000CDevice
    {
            ...
            : base("IFF Mode Setting Display", new Size(600, 190))
        {
            ...
            AddDrum("Mode-1 Tens Drum", "{M2000C}/Gauges/Common/drum_tape.xaml", "Mode-1 Tens Drum", "(0-9)", "#", new Point(81, 90), new Size(10, 15), new Size(26, 39));
            AddRotarySwitch("Mode-1 Ones Selector", new Point(184, 64), new Size(46, 81), 10);
            AddDrum("Mode-1 Ones Drum", "{M2000C}/Gauges/Common/drum_tape.xaml", "Mode-1 Ones Drum", "(0-9)", "#", new Point(157, 90), new Size(10, 15), new Size(26, 39));

            AddRotarySwitch("Mode-3A Thousands Selector", new Point(290, 64), new Size(46, 81), 10);
            AddDrum("Mode-3A Thousands Drum", "{M2000C}/Gauges/Common/drum_tape.xaml", "Mode-3A Thousands Drum", "(0-9)", "#", new Point(263, 90), new Size(10, 15), new Size(26, 39));
            AddRotarySwitch("Mode-3A Hundreds Selector", new Point(366, 64), new Size(46, 81), 10);
            AddDrum("Mode-3A Hundreds Drum", "{M2000C}/Gauges/Common/drum_tape.xaml", "Mode-3A Hundreds Drum", "(0-9)", "#", new Point(341, 90), new Size(10, 15), new Size(26, 39));
            AddRotarySwitch("Mode-3A Tens Selector", new Point(443, 64), new Size(46, 81), 10);
            AddDrum("Mode-3A Tens Drum", "{M2000C}/Gauges/Common/drum_tape.xaml", "Mode-3A Tens Drum", "(0-9)", "#", new Point(419, 90), new Size(10, 15), new Size(26, 39));
            AddRotarySwitch("Mode-3A Ones Selector", new Point(519, 64), new Size(46, 81), 10);
            AddDrum("Mode-3A Ones Drum", "{M2000C}/Gauges/Common/drum_tape.xaml", "Mode-3A Ones Drum", "(0-9)", "#", new Point(495, 90), new Size(10, 15), new Size(26, 39));
        }
