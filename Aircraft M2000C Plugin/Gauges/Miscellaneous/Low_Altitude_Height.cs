...
namespace GadrocsWorkshop.Helios.Gauges.M2000C
{
    ...
    class LowAltitudeSetting : M2000CDevice
    {
            ...
            : base("Low Altitude Setting Display", new Size(400, 205))
        {
            ...
            AddDrum("Altitude 10 000 ft Drum", "{M2000C}/Gauges/Common/drum_tape.xaml", "Altitude 10 000 ft Drum", "(0-3)", "#", new Point(115,79), new Size(10, 15), new Size(24,44));
            AddRotarySwitch("Altitude 1 000 ft Selector", new Point(168, 46), new Size(68, 111), 10);
            AddDrum("Altitude 1 000 ft Drum", "{M2000C}/Gauges/Common/drum_tape.xaml", "Altitude 1 000 ft Drum", "(0-9)", "#", new Point(193, 79), new Size(10, 15), new Size(24, 44));
            AddRotarySwitch("Altitude 100 ft Selector", new Point(240, 46), new Size(68, 111), 10);
            AddDrum("Altitude 100 ft Drum", "{M2000C}/Gauges/Common/drum_tape.xaml", "Altitude 100 ft Drum", "(0-9)", "#", new Point(274, 79), new Size(10, 15), new Size(24, 44));
        }
