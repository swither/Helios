...
namespace GadrocsWorkshop.Helios.Gauges.M2000C
{
    ...
    [HeliosControl("HELIOS.M2000C.FUEL_PANEL", "Fuel Panel", "M-2000C Gauges", typeof(BackgroundImageRenderer),HeliosControlFlags.NotShownInUI)]
    class M2000C_FuelPanel : M2000CDevice
    {
            ...
            : base("Fuel Panel", new Size(223, 396))
        {
            ...
            AddDrum("Internal Fuel Quantity (Tens)", "{M2000C}/Gauges/Common/drum_tape.xaml", "tens quantity", "(0 - 10)", "#",
                new Point(77, row6), new Size(10d, 15d), new Size(12d, 19d));
            AddDrum("Internal Fuel Quantity (Hundreds)", "{M2000C}/Gauges/Common/drum_tape.xaml", "hundreds quantity", "(0 - 10)", "#",
                new Point(52, row6), new Size(10d, 15d), new Size(12d, 19d));
            AddDrum("Internal Fuel Quantity (Thousands)", "{M2000C}/Gauges/Common/drum_tape.xaml", "thousands quantity", "(0 - 10)", "#",
                new Point(28, row6), new Size(10d, 15d), new Size(12d, 19d));
            AddDrum("Total Fuel Quantity (Tens)", "{M2000C}/Gauges/Common/drum_tape.xaml", "tens quantity", "(0 - 10)", "#",
                new Point(167, row6), new Size(10d, 15d), new Size(12d, 19d));
            AddDrum("Total Fuel Quantity (Hundreds)", "{M2000C}/Gauges/Common/drum_tape.xaml", "hundreds quantity", "(0 - 10)", "#",
                new Point(142, row6), new Size(10d, 15d), new Size(12d, 19d));
            AddDrum("Total Fuel Quantity (Thousands)", "{M2000C}/Gauges/Common/drum_tape.xaml", "thousands quantity", "(0 - 10)", "#",
