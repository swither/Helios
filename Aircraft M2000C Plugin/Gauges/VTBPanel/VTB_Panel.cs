...
namespace GadrocsWorkshop.Helios.Gauges.M2000C
{
    ...
    class M2000C_VTBPanel : M2000CDevice
    {
        ...
        {
            Mk2CDrumGauge.Mk2CDrumGauge newGauge = new Mk2CDrumGauge.Mk2CDrumGauge($"{Name}_{name}", "{M2000C}/Gauges/Common/drum_tape.xaml", name, valueDescription, "#", posn, size, renderSize, 1d, -1d, 7d);
