...
namespace GadrocsWorkshop.Helios.Gauges.M2000C.VorIlsChannel
{
    ...
    class M2000C_VorIlsPanel : M2000CDevice
    {
            ...
            : base("VOR/ILS Panel", new Size(350, 314))
        {
            ...
            AddDrum("Channel output for display (Decimal Ones)", "{M2000C}/Gauges/Common/drum_tape.xaml", "decimal ones frequency", "(0 or 5)", "#",
                new Point(213, 67), new Size(10d, 15d), new Size(33d,60d));
            AddDrum("Channel output for display (Decimal Tens)", "{M2000C}/Gauges/Common/drum_tape_with_point.xaml", "decimal tens frequency", "(0 - 9)", "#",
                new Point(176, 67), new Size(11d, 15d), new Size(36d, 60d));
            AddDrum("Channel output for display (Ones)", "{M2000C}/Gauges/Common/drum_tape.xaml", "ones frequency", "(0 - 9)", "#",
                new Point(142, 67), new Size(10d, 15d), new Size(33d, 60d));
            AddDrum("Channel output for display (Tens)", "{M2000C}/Gauges/Common/drum_tape.xaml", "tens frequency", "(0 - 1)", "#",
