...
namespace GadrocsWorkshop.Helios.Gauges.M2000C
{
    ...
    [HeliosControl("HELIOS.M2000C.ENGINESENSORS_PANEL", "Engine Sensors Panel", "M-2000C Gauges", typeof(BackgroundImageRenderer),HeliosControlFlags.NotShownInUI)]
    class M2000C_ENGINESENSORSPanel : M2000CDevice
    {
        ...
        {
            AddDrum("Engine RPM (%) (Tens)", "{M2000C}/Gauges/Common/drum_tape.xaml", "tens engine pourcentage", "(0 - 10)", "##",
                new Point(54, 112), new Size(10d, 15d), new Size(12d, 20d));
            AddDrum("Engine RPM (%) (Ones)", "{M2000C}/Gauges/Common/drum_tape.xaml", "ones engine pourcentage", "(0 - 9)", "#",
                new Point(78, 112), new Size(10d, 15d), new Size(12d, 20d));
            double[,] rpmCalibrationPoints = new double[,] {
                 { 0.5d, -15d },
                 { 0.8d, 60d },
                };
            AddNeedle("Engine RPM Needle", "{M2000C}/Gauges/Common/needleA.xaml", "engine pourcentage", "(0 - 100)", 
            ...
            AddNeedle("Engine T7 Needle", "{M2000C}/Gauges/Common/needleB.xaml", "engine temperature", "(0 - 10)",
