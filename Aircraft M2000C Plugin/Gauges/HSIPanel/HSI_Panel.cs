...
namespace GadrocsWorkshop.Helios.Gauges.M2000C
{
    ...
    class M2000C_HSIPanel : M2000CDevice
    {
            ...
            : base("HSI Panel", new Size(300, 287))
        {
            ...
            AddDrum("Distance (Decimals)", "{M2000C}/Gauges/Common/drum_tape.xaml", "decimal distance", "(0 - 9)", "#",
                new Point(column3, row0), new Size(10d, 15d), new Size(20d, 30d));
            AddDrum("Distance (Ones)", "{M2000C}/Gauges/Common/drum_tape.xaml", "ones distance", "(0 - 9)", "#",
                new Point(column2, row0), new Size(10d, 15d), new Size(20d, 30d));
            AddDrum("Distance (Tens)", "{M2000C}/Gauges/Common/drum_tape.xaml", "tens distance", "(0 - 9)", "#",
                new Point(column1, row0), new Size(10d, 15d), new Size(20d, 30d));
            AddDrum("Distance (Hundreds)", "{M2000C}/Gauges/Common/drum_tape.xaml", "hundreds distance", "(0 - 9)", "#",
                new Point(column0, row0), new Size(10d, 15d), new Size(20d, 30d));

            AddNeedle("Compass Rose", "{M2000C}/Gauges/HSIPanel/compass.xaml", "compass", "(0 - 360)", 
