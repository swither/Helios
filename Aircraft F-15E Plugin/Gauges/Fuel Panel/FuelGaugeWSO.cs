...
namespace GadrocsWorkshop.Helios.Gauges.F15E
{
    ...
    public class FuelGaugeWSO : BaseGauge
        ...
        {
            _giDial = new GaugeImage("{F-15E}/Gauges/Fuel Panel/InternalDialWSO.xaml", new Rect(0d, 0d, 300d, 300d));
            Components.Add(_giDial);

            _internalFuelNeedleCalibration = new CalibrationPointCollectionDouble(0.0d, 0d, 14000d, 248d);
            _internalFuelNeedle = new GaugeNeedle("{F-15E}/Gauges/Instruments/NeedleA.xaml", new Point(150d, 150d), new Size(34, 214), new Point(17, 130), -126d);
