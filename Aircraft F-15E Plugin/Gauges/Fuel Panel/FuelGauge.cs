...
namespace GadrocsWorkshop.Helios.Gauges.F15E
{
    ...
    public class FuelGauge : BaseGauge
        ...
        public FuelGauge(string name, Size size)
            : base(name, size)
        {
            _giDial = new GaugeImage("{F-15E}/Gauges/Fuel Panel/InternalDial.xaml", new Rect(0d, 0d, 164d, 164d));
            ...
            _internalFuelNeedle = new GaugeNeedle("{F-15E}/Gauges/Fuel Panel/Needle.xaml", new Point(82d, 82d), new Size(36d*0.4d, 154d * 0.4d), new Point(18d * 0.4d, 136d * 0.4d), -126d);
            Components.Add(_internalFuelNeedle);
            _bingoNeedle = new GaugeNeedle("{F-15E}/Gauges/Fuel Panel/BingoNeedle.xaml", new Point(82d, 82d), new Size(46d * .25d, 205d * .4d), new Point(23d * .25d, 205d * .4d), -126d);
