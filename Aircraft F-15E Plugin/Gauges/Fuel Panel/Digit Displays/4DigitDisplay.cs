...
namespace GadrocsWorkshop.Helios.Gauges.F15E.FuelPanel
{
    ...
    public class FourDigitDisplay : BaseGauge
    {
            ...
            : base(interfaceElement, new Size(275, 100))
        {
            ...
            _thousandsDrum = new GaugeDrumCounter("{F-15E}/Gauges/Common/units_drum_tape_reversed.xaml", new Point(13.5d, 11.5d), "#", new Size(10d, 15d), new Size(50d, 75d));
            _thousandsDrum.Clip = new RectangleGeometry(new Rect(13.5d, 11.5d, 50d, 75d));
            Components.Add(_thousandsDrum);

            _hundredsDrum = new GaugeDrumCounter("{F-15E}/Gauges/Common/hundreds_drum_tape_reversed.xaml", new Point(79.5d, 11.5d), "$", new Size(30d, 15d), new Size(150d, 75d));
