...
namespace GadrocsWorkshop.Helios.Gauges.F15E.FuelPanel
{
    ...
    public class FiveDigitDisplay : BaseGauge
    {
            ...
            : base(interfaceElement, new Size(339, 100))
        {
            ...
            _10kDrum = new GaugeDrumCounter("{F-15E}/Gauges/Common/alt_units_drum_tape_reversed.xaml", new Point(13.5d, 11.5d), "#", new Size(10d, 15d), new Size(50d, 75d));
            _10kDrum.Clip = new RectangleGeometry(new Rect(13.5d, 11.5d, 50d, 75d));
            Components.Add(_10kDrum);
            _10kDrum.FastRoll = true;

            _1kDrum = new GaugeDrumCounter("{F-15E}/Gauges/Common/units_drum_tape_reversed.xaml", new Point(79.5d, 11.5d), "#", new Size(10d, 15d), new Size(50d, 75d));
            _1kDrum.Clip = new RectangleGeometry(new Rect(79.5d, 11.5d, 50d, 75d));
            Components.Add(_1kDrum);

            _hundredsDrum = new GaugeDrumCounter("{F-15E}/Gauges/Common/hundreds_drum_tape_reversed.xaml", new Point(145.5d, 11.5d), "$", new Size(30d, 15d), new Size(150d, 75d));
