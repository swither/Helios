...
namespace GadrocsWorkshop.Helios.Gauges.F15E.Instruments.ADI
{
    ...
    [HeliosControl("Helios.F15E.Instruments.ADI.Pilot", "ADI (Pilot)", "F-15E Strike Eagle", typeof(BackgroundImageRenderer), HeliosControlFlags.NotShownInUI)]
    class ADIPilot : CompositeVisualWithBackgroundImage
    {
        ...
        public ADIPilot()
            : base("ADI Gauge (Pilot)", new Size(400, 400))
        {
            SupportedInterfaces = new[] { typeof(Interfaces.DCS.F15E.F15EInterface) };
            AddGauge("ADI", new Point(0d, 0d), new Size(400d, 400d), _interfaceDeviceName, "ADI");
