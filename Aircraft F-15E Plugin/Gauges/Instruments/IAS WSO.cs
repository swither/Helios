...
namespace GadrocsWorkshop.Helios.Gauges.F15E.Instruments.IAS
{
    ...
    [HeliosControl("Helios.F15E.Instruments.IAS.WSO", "Indicated Air Speed (WSO)", "F-15E Strike Eagle", typeof(BackgroundImageRenderer),HeliosControlFlags.NotShownInUI)]
    class IASWso : CompositeVisualWithBackgroundImage
    {
        ...
        public IASWso()
            : base("IAS Gauge (WSO)", new Size(300, 300))
        {
