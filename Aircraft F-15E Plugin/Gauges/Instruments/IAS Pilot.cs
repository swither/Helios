...
namespace GadrocsWorkshop.Helios.Gauges.F15E.Instruments.IAS
{
    ...
    [HeliosControl("Helios.F15E.Instruments.IAS.Pilot", "Indicated Air Speed (Pilot)", "F-15E Strike Eagle", typeof(BackgroundImageRenderer), HeliosControlFlags.NotShownInUI)]
