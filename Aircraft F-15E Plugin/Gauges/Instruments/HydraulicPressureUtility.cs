...
namespace GadrocsWorkshop.Helios.Gauges.F15E.Instruments.HydraulicPressure
{
    ...
    [HeliosControl("Helios.F15E.Instruments.HydraulicPressure.Utility", "Hydraulic Pressure (Utility)", "F-15E Strike Eagle", typeof(BackgroundImageRenderer),HeliosControlFlags.NotShownInUI)]
    class HydraulicPressureUtility : CompositeVisualWithBackgroundImage
    {
        private string _interfaceDeviceName = "Instruments";
        private HydraulicPressureGauge _display;
        ...
        public HydraulicPressureUtility()
            : base("Hydraulic Pressure Gauge (Utility)", new Size(300, 300))
        {
            SupportedInterfaces = new[] { typeof(Interfaces.DCS.F15E.F15EInterface) };
            AddGauge("Utility Hydraulic Pressure Gauge", new Point(0d, 0d), new Size(300d, 300d), _interfaceDeviceName, "Utility Hydraulic Pressure Gauge");
        ...
        {
            _display = new HydraulicPressureGauge(name, new Size(300, 300), _interfaceDeviceName)
            {
                Top = pos.Y,
                Left = pos.X,
                Height = size.Height,
