...
namespace GadrocsWorkshop.Helios.Gauges.F15E.Instruments.HydraulicPressure
{
    ...
    [HeliosControl("Helios.F15E.Instruments.HydraulicPressure.PC1", "Hydraulic Pressure (PC 1)", "F-15E Strike Eagle", typeof(BackgroundImageRenderer), HeliosControlFlags.NotShownInUI)]
    class HydraulicPressurePC1 : CompositeVisualWithBackgroundImage
    {
        ...
        public HydraulicPressurePC1()
            : base("Hydraulic Pressure Gauge (PC1)", new Size(300, 300))
        {
            SupportedInterfaces = new[] { typeof(Interfaces.DCS.F15E.F15EInterface) };
            AddGauge("PC 1 Hydraulic Pressure Gauge", new Point(0d, 0d), new Size(300d, 300d), _interfaceDeviceName, "PC 1 Hydraulic Pressure Gauge");
