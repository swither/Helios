...
namespace GadrocsWorkshop.Helios.Gauges.F15E.Instruments.PitchRatio
{
    ...
    [HeliosControl("Helios.F15E.Instruments.PitchRatio", "Pitch Ratio Gauge", "F-15E Strike Eagle", typeof(BackgroundImageRenderer),HeliosControlFlags.NotShownInUI)]
    class PitchRatio : CompositeVisualWithBackgroundImage
    {
        private string _interfaceDeviceName = "CAS";
        private PitchRatioGauge _display;
        ...
        public PitchRatio()
            : base("Pitch Ratio Gauge", new Size(300,300))
        {
            SupportedInterfaces = new[] { typeof(Interfaces.DCS.F15E.F15EInterface) };
            AddGauge("Pitch Ratio", new Point(0d, 0d), new Size(300d, 300d), _interfaceDeviceName, "Pitch Ratio");
