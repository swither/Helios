...
namespace GadrocsWorkshop.Helios.Gauges.F15E.Instruments.OxygenPressure
{
    ...
    [HeliosControl("Helios.F15E.Instruments.OxygenPressure.Pilot", "Oxygen Pressure Gauge (Pilot)", "F-15E Strike Eagle", typeof(BackgroundImageRenderer), HeliosControlFlags.NotShownInUI)]
    class OxygenPressurePilot : CompositeVisualWithBackgroundImage
    {
        private string _interfaceDeviceName = "Oxygen Panel (Pilot)";
        private OxygenPressureGauge _display;
        ...
        public OxygenPressurePilot()
            : base("Oxygen Pressure Gauge (Pilot)", new Size(300, 300))
        {
            SupportedInterfaces = new[] { typeof(Interfaces.DCS.F15E.F15EInterface) };
            AddGauge("Oxygen Pressure", new Point(0d, 0d), new Size(300d, 300d), _interfaceDeviceName, "Oxygen Pressure");
        ...
        {
            _display = new OxygenPressureGauge(name, new Size(300, 300), _interfaceDeviceName)
            {
                Top = pos.Y,
                Left = pos.X,
                Height = size.Height,
