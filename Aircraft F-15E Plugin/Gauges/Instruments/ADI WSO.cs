...
namespace GadrocsWorkshop.Helios.Gauges.F15E.Instruments.ADI
{
    ...
    [HeliosControl("Helios.F15E.Instruments.ADI.WSO", "ADI (WSO)", "F-15E Strike Eagle", typeof(BackgroundImageRenderer),HeliosControlFlags.NotShownInUI)]
    class ADIWso : CompositeVisualWithBackgroundImage
    {
        ...
        public ADIWso()
            : base("ADI Gauge (WSO)", new Size(400, 400))
        {
