...
namespace GadrocsWorkshop.Helios.Gauges.F15E.Instruments.CabinPressure
{
    ...
    public class CabinPressureGauge : BaseGauge
    {
        ...
        public CabinPressureGauge(string name, Size size, string device)
            : base(name, size)
        {
            Components.Add(new GaugeImage("{F-15E}/Gauges/Instruments/CabinPressureDial.xaml", new Rect(0d, 0d, 300d, 300d)));

            _needle = new GaugeNeedle("{F-15E}/Gauges/Instruments/NeedleA.xaml", new Point(150d, 150d), new Size(34, 214), new Point(17, 130), 180d);
