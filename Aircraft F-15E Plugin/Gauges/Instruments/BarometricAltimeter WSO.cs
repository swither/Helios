...
namespace GadrocsWorkshop.Helios.Gauges.F15E.Instruments.BarometricAltimeter
{
    ...
    [HeliosControl("Helios.F15E.Instruments.BAltimeter.WSO", "Barometric Altimeter (WSO)", "F-15E Strike Eagle", typeof(BackgroundImageRenderer), HeliosControlFlags.NotShownInUI)]
    class BAltimeterWso : CompositeVisualWithBackgroundImage
    {
        ...
        public BAltimeterWso()
            : base("Barometric Alimeter Gauge (WSO)", new Size(300, 300))
        {
