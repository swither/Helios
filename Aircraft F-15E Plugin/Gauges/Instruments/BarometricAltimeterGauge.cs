...
namespace GadrocsWorkshop.Helios.Gauges.F15E.Instruments.BarometricAltimeter
{
    ...
    public class BAltimeterGauge : BaseGauge
    {
            ...
            : base(name, size)
        {
            ...
            Components.Add(new GaugeImage("{F-15E}/Gauges/Instruments/BarometricAltimeterDial.xaml", new Rect(0d, 0d, size.Width, size.Height)));

            _needleCalibration = new CalibrationPointCollectionDouble(0d, 0d, 1000d, 360d);
            _needle = new GaugeNeedle("{F-15E}/Gauges/Instruments/NeedleC.xaml", new Point(150d, 150d), new Size(30d, 200d), new Point(15d, 128.9d));
