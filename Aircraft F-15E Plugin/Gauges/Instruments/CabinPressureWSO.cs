...
namespace GadrocsWorkshop.Helios.Gauges.F15E.Instruments.CabinPressure
{
    ...
    using GadrocsWorkshop.Helios.Gauges.F15E.Instruments.AOA;
    using System;
    using System.Globalization;
    using System.Windows;
    using System.Xml;

    [HeliosControl("Helios.F15E.Instruments.CabinPressure.WSO", "Cabin Pressure (WSO)", "F-15E Strike Eagle", typeof(BackgroundImageRenderer),HeliosControlFlags.NotShownInUI)]
    class CabinPressureWso : CompositeVisualWithBackgroundImage
    {
        private string _interfaceDeviceName = "Flight Instruments (WSO)";
        private CabinPressureGauge _display;
        ...
        public CabinPressureWso()
            : base("Cabin Pressure Gauge (WSO)", new Size(300, 300))
        {
            SupportedInterfaces = new[] { typeof(Interfaces.DCS.F15E.F15EInterface) };
            AddGauge("Cabin Pressure", new Point(0d, 0d), new Size(300d, 300d), _interfaceDeviceName, "Cabin Pressure");
        ...
        {
            _display = new CabinPressureGauge(name, new Size(300, 300), _interfaceDeviceName)
            {
                Top = pos.Y,
                Left = pos.X,
                Height = size.Height,
