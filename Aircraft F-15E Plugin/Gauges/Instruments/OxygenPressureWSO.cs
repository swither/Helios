...
namespace GadrocsWorkshop.Helios.Gauges.F15E.Instruments.OxygenPressure
{
    ...
    [HeliosControl("Helios.F15E.Instruments.OxygenPressure.WSO", "Oxygen Pressure Gauge (WSO)", "F-15E Strike Eagle", typeof(BackgroundImageRenderer),HeliosControlFlags.NotShownInUI)]
    class OxygenPressureWso : CompositeVisualWithBackgroundImage
    {
        private string _interfaceDeviceName = "Oxygen Panel (WSO)";
        ...
        public OxygenPressureWso()
            : base("Oxygen Pressure Gauge (WSO)", new Size(300, 300))
        {
