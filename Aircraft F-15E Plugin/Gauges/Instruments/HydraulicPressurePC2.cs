...
namespace GadrocsWorkshop.Helios.Gauges.F15E.Instruments.HydraulicPressure
{
    ...
    [HeliosControl("Helios.F15E.Instruments.HydraulicPressure.PC2", "Hydraulic Pressure (PC 2)", "F-15E Strike Eagle", typeof(BackgroundImageRenderer), HeliosControlFlags.NotShownInUI)]
    class HydraulicPressurePC2 : CompositeVisualWithBackgroundImage
    {
        ...
        public HydraulicPressurePC2()
            : base("Hydraulic Pressure Gauge (PC2)", new Size(300, 300))
        {
            SupportedInterfaces = new[] { typeof(Interfaces.DCS.F15E.F15EInterface) };
            AddGauge("PC 2 Hydraulic Pressure Gauge", new Point(0d, 0d), new Size(300d, 300d), _interfaceDeviceName, "PC 2 Hydraulic Pressure Gauge");
