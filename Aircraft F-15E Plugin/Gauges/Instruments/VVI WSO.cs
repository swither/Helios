...
namespace GadrocsWorkshop.Helios.Gauges.F15E.Instruments.VVI
{
    ...
    [HeliosControl("Helios.F15E.Instruments.VVI.WSO", "Vertical Velocity Indicator (WSO)", "F-15E Strike Eagle", typeof(BackgroundImageRenderer),HeliosControlFlags.NotShownInUI)]
    class VVIWso : CompositeVisualWithBackgroundImage
    {
        ...
        public VVIWso()
            : base("VVI Gauge (WSO)", new Size(300, 300))
        {
