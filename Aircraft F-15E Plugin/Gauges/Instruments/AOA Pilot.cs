...
namespace GadrocsWorkshop.Helios.Gauges.F15E.Instruments.AOA
{
    ...
    [HeliosControl("Helios.F15E.Instruments.AoA.Gauge.Pilot", "Angle of Attack (Pilot)", "F-15E Strike Eagle", typeof(BackgroundImageRenderer), HeliosControlFlags.NotShownInUI)]
    class AOAPilot : CompositeVisualWithBackgroundImage
    {
        private string _interfaceDeviceName = "Flight Instruments";
        private AOAGauge _display;
        ...
        public AOAPilot()
            : base("AoA Gauge (Pilot)", new Size(300, 300))
        {
            SupportedInterfaces = new[] { typeof(Interfaces.DCS.F15E.F15EInterface) };
            AddGauge("Angle of Attack", new Point(0d, 0d), new Size(300d, 300d), _interfaceDeviceName, "Angle of Attack");
        ...
        {
            _display = new AOAGauge(name, new Size(300, 300), _interfaceDeviceName)
            {
                Top = pos.Y,
                Left = pos.X,
                Height = size.Height,
