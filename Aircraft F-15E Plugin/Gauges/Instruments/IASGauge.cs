...
namespace GadrocsWorkshop.Helios.Gauges.F15E.Instruments.IAS
{
    ...
    public class IASGauge : BaseGauge
    {
            ...
            : base(name, size)
        {
            ...
            Components.Add(new GaugeImage("{F-15E}/Gauges/Instruments/IASDial.xaml", new Rect(0d, 0d, 300, 300)));
            ...
            _needle = new GaugeNeedle("{F-15E}/Gauges/Instruments/NeedleB.xaml", new Point(150d, 150d), new Size(14d, 140d), new Point(7d, 135d), 0d);
