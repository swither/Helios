...
namespace GadrocsWorkshop.Helios.Gauges.F15E.Instruments.VVI
{
    ...
    using GadrocsWorkshop.Helios.Gauges.F15E.Instruments.IAS;
    using System;
    using System.Globalization;
    using System.Windows;
    using System.Xml;

    [HeliosControl("Helios.F15E.Instruments.VVI.Pilot", "Vertical Velocity Indicator (Pilot)", "F-15E Strike Eagle", typeof(BackgroundImageRenderer), HeliosControlFlags.NotShownInUI)]
    class VVIPilot : CompositeVisualWithBackgroundImage
    {
        ...
        public VVIPilot()
            : base("VVI Gauge (Pilot)", new Size(300, 300))
        {
