...
namespace GadrocsWorkshop.Helios.Gauges.F15E.Instruments.BarometricAltimeter
{
    ...
    [HeliosControl("Helios.F15E.Instruments.BAltimeter.Pilot", "Barometric Altimeter (Pilot)", "F-15E Strike Eagle", typeof(BackgroundImageRenderer), HeliosControlFlags.NotShownInUI)]
    class BAltimeterPilot : CompositeVisualWithBackgroundImage
    {
        private string _interfaceDeviceName = "Flight Instruments";
        private BAltimeterGauge _display;
        ...
        public BAltimeterPilot()
            : base("Barometric Alimeter Gauge (Pilot)", new Size(300, 300))
        {
            SupportedInterfaces = new[] { typeof(Interfaces.DCS.F15E.F15EInterface) };
            AddGauge("Altimeter", new Point(0d, 0d), new Size(300d, 300d), _interfaceDeviceName, "Altimeter");
        ...
        {
            _display = new BAltimeterGauge(name, new Size(300, 300), _interfaceDeviceName)
            {
                Top = pos.Y,
                Left = pos.X,
                Height = size.Height,
