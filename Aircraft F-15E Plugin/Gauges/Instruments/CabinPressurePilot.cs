...
namespace GadrocsWorkshop.Helios.Gauges.F15E.Instruments.CabinPressure
{
    ...
    [HeliosControl("Helios.F15E.Instruments.CabinPressure.Pilot", "Cabin Pressure (Pilot)", "F-15E Strike Eagle", typeof(BackgroundImageRenderer), HeliosControlFlags.NotShownInUI)]
    class CabinPressurePilot : CompositeVisualWithBackgroundImage
    {
        ...
        public CabinPressurePilot()
            : base("Cabin Pressure Gauge (Pilot)", new Size(300, 300))
        {
