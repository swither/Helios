...
namespace GadrocsWorkshop.Helios.Gauges.F15E.Clock
{
    ...
    public class ClockGauge : BaseGauge
    {
            ...
            : base(name, size)
        {
            ...
            Components.Add(new GaugeImage("{F-15E}/Gauges/Clock/Clock_Dial.xaml", new Rect(0d, 0d, size.Width, size.Height)));
            _clockHoursNeedle = new GaugeNeedle("{F-15E}/Gauges/Instruments/NeedleHours.xaml", center, new Size(32d, 91d), new Point(16d, 75d));
            Components.Add(_clockHoursNeedle);

            _clockMinutesNeedle = new GaugeNeedle("{F-15E}/Gauges/Instruments/NeedleMinutes.xaml", center, new Size(32d, 131d), new Point(16d, 115d));
            Components.Add(_clockMinutesNeedle);

            _clockSecondsNeedle = new GaugeNeedle("{F-15E}/Gauges/Instruments/NeedleSeconds.xaml", center, new Size(32d, 206d), new Point(16d, 133.4d));
