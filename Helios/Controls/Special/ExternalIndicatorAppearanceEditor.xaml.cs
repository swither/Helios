...
namespace GadrocsWorkshop.Helios.Controls
{
    ...
    /// <summary>
    /// Interaction logic for ExternalIndicatorAppearanceEditor.xaml
    /// </summary>
    [HeliosPropertyEditor("Helios.Base.Special.ExternalIndicatorControl", "Appearance")]
    public partial class ExternalIndicatorAppearanceEditor : HeliosPropertyEditor
    {
        public ExternalIndicatorAppearanceEditor()
        {
            InitializeComponent();
        }
