...
namespace GadrocsWorkshop.Helios.Controls
{
    ...
    [HeliosControl("Helios.Base.RotarySwitchRemoveMe", "Rotary Switch - Legacy", "Rotary Switches", typeof(RotarySwitchRenderer))]
    public class RotarySwitchRemoveMe : HeliosVisual
    {
        ...
        public double Sensitivity
        {
            ...
            set
            {
                if (!_sensitivity.Equals(value))
                {
                    ...
                    _sensitivity = value;
                    _swipeThreshold = SWIPE_SENSITIVY_BASE * _swipeCalibration.Interpolate(_sensitivity);
