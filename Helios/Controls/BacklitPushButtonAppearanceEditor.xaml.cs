...
namespace GadrocsWorkshop.Helios.Controls
{
    ...
    /// </summary>
    [HeliosPropertyEditor("Helios.Base.BacklitPushButton", "Appearance")]
    public partial class BacklitPushButtonAppearanceEditor : HeliosPropertyEditor
    {
        public BacklitPushButtonAppearanceEditor()
        {
            InitializeComponent();
        }
