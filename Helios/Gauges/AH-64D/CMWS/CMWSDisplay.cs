...
namespace GadrocsWorkshop.Helios.Gauges.AH64D.CMWS
{
    ...
    public class CMWSDisplay : CompositeVisualWithBackgroundImage
    {
            ...
            : base("CMWS Display", new Size(640, 409))
        {
            ...
            AddTextDisplay("Line 1", new Point(206d, 29d), new Size(144d, 55d), _interfaceDeviceName, "Line 1", 25, "F OUT", TextHorizontalAlignment.Left, "");
            AddTextDisplay("Line 2", new Point(206d, 84d), new Size(144d, 55d), _interfaceDeviceName, "Line 2", 25, "C OUT", TextHorizontalAlignment.Left, "");
