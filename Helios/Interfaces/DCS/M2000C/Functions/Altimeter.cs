    ...
    public class Altimeter : DCSFunctionPair
    {
        ...
        public Altimeter(BaseUDPInterface sourceInterface)
            : base(sourceInterface,
                   "Flight Instruments", "Barometric Altitude", "Altitude above sea level of the aircraft.",
                   "Flight Instruments", "Pressure Adjustment", "Manually set barometric pressure adjustment.")
        {
            DoBuild();
        }
        ...
        private void DoBuild()
        {
            ...
            _pressure = new HeliosValue(SourceInterface, BindingValue.Empty, SerializedDeviceName2, SerializedFunctionName2,
                SerializedDescription2, "", BindingValueUnits.Millibar);
