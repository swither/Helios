...
namespace GadrocsWorkshop.Helios.Interfaces.DCS.A10C.Functions
{
    ...
    public class VHFRadioEncoder : Axis
    {
        private double _lastData;
        private HeliosValue _windowValue;

        public VHFRadioEncoder(BaseUDPInterface sourceInterface, string deviceId, string buttonId, string argId, double stepValue, double argMin, double argMax, string device, string name)
        ...
        public VHFRadioEncoder(BaseUDPInterface sourceInterface, System.Runtime.Serialization.StreamingContext context)
