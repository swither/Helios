...
namespace GadrocsWorkshop.Helios.Interfaces.DCS.Template.Functions
{
    public class ExampleFunction : DCSFunction
    {
        ...
        public ExampleFunction(BaseUDPInterface sourceInterface, string device, string name, string description)
        ...
        public ExampleFunction(BaseUDPInterface sourceInterface, System.Runtime.Serialization.StreamingContext context)
