...
namespace GadrocsWorkshop.Helios.Interfaces.DCS.AH64D
{
    ...
    public class AH64DInterface : DCSInterface
    {
            ...
            : base(name, "AH-64D_BLK_II", "pack://application:,,,/Helios;component/Interfaces/DCS/AH64D/ExportFunctions.lua")
        {
            ...
            AddFunction(new PushButton(this, KU_PLT, KU_commands.keyDot.ToString("d"), "246", "Keyboard Unit (Pilot)", "Key - ."));
            ...
            AddFunction(new PushButton(this, KU_PLT, KU_commands.keyDivide.ToString("d"), "255", "Keyboard Unit (Pilot)", "Key - / (divide)"));
            ...
            AddFunction(new PushButton(this, KU_PLT, KU_commands.keyLeft.ToString("d"), "259", "Keyboard Unit (Pilot)", "Key - Left"));
            AddFunction(new PushButton(this, KU_PLT, KU_commands.keyRight.ToString("d"), "260", "Keyboard Unit (Pilot)", "Key - Right"));
            ...
            AddFunction(new PushButton(this, KU_CPG, KU_commands.keyDot.ToString("d"), "197", "Keyboard Unit (CP/G)", "Key - ."));
            ...
            AddFunction(new PushButton(this, KU_CPG, KU_commands.keyDivide.ToString("d"), "206", "Keyboard Unit (CP/G)", "Key - / ('divide'"));
            ...
            AddFunction(new PushButton(this, KU_CPG, KU_commands.keyLeft.ToString("d"), "210", "Keyboard Unit (CP/G)", "Key - Left"));
            AddFunction(new PushButton(this, KU_CPG, KU_commands.keyRight.ToString("d"), "211", "Keyboard Unit (CP/G)", "Key - Right"));
            ...
            #region Pilot
            AddFunction(new Switch(this, EUFD_PLT, "271", new SwitchPosition[] { new SwitchPosition("1.0", "Up", eufd_commands.WCA_DOWN.ToString("d")), new SwitchPosition("0.0", "Middle", eufd_commands.WCA_DOWN.ToString("d")), new SwitchPosition("-1.0", "Down", eufd_commands.WCA_UP.ToString("d")) }, "Up Front Display (Pilot)", "WCA Rocker Switch", "%0.1f"));
            AddFunction(new Switch(this, EUFD_PLT, "270", new SwitchPosition[] { new SwitchPosition("1.0", "Up", eufd_commands.IDM_DOWN.ToString("d")), new SwitchPosition("0.0", "Middle", eufd_commands.IDM_DOWN.ToString("d")), new SwitchPosition("-1.0", "Down", eufd_commands.IDM_UP.ToString("d")) }, "Up Front Display (Pilot)", "IDM Rocker Switch", "%0.1f"));
            AddFunction(new Switch(this, EUFD_PLT, "272", new SwitchPosition[] { new SwitchPosition("1.0", "Up", eufd_commands.RTS_DOWN.ToString("d")), new SwitchPosition("0.0", "Middle", eufd_commands.RTS_DOWN.ToString("d")), new SwitchPosition("-1.0", "Down", eufd_commands.RTS_UP.ToString("d")) }, "Up Front Display (Pilot)", "RTS Rocker Switch", "%0.1f"));
            ...
            #endregion
            #region CP/G
            AddFunction(new Switch(this, EUFD_CPG, "263", new SwitchPosition[] { new SwitchPosition("1.0", "Up", eufd_commands.WCA_DOWN.ToString("d")), new SwitchPosition("0.0", "Middle", eufd_commands.WCA_DOWN.ToString("d")), new SwitchPosition("-1.0", "Down", eufd_commands.WCA_UP.ToString("d")) }, "Up Front Display (CP/G)", "WCA Rocker Switch", "%0.1f"));
            AddFunction(new Switch(this, EUFD_CPG, "262", new SwitchPosition[] { new SwitchPosition("1.0", "Up", eufd_commands.IDM_DOWN.ToString("d")), new SwitchPosition("0.0", "Middle", eufd_commands.IDM_DOWN.ToString("d")), new SwitchPosition("-1.0", "Down", eufd_commands.IDM_UP.ToString("d")) }, "Up Front Display (CP/G)", "IDM Rocker Switch", "%0.1f"));
            AddFunction(new Switch(this, EUFD_CPG, "264", new SwitchPosition[] { new SwitchPosition("1.0", "Up", eufd_commands.RTS_DOWN.ToString("d")), new SwitchPosition("0.0", "Middle", eufd_commands.RTS_DOWN.ToString("d")), new SwitchPosition("-1.0", "Down", eufd_commands.RTS_UP.ToString("d")) }, "Up Front Display (CP/G)", "RTS Rocker Switch", "%0.1f"));
            ...
            AddFunction(new Switch(this, TEDAC, "155", new SwitchPosition[] { new SwitchPosition("1.0", "Dec", tedac_commands.TDU_SYM_DEC.ToString("d")), new SwitchPosition("0.0", "Mid", tedac_commands.TDU_SYM_INC.ToString("d")), new SwitchPosition("-1.0", "Inc", tedac_commands.TDU_SYM_INC.ToString("d")) }, "TEDAC", "SYM Rocker Switch", "%0.1f"));
            AddFunction(new Switch(this, TEDAC, "156", new SwitchPosition[] { new SwitchPosition("1.0", "Dec", tedac_commands.TDU_BRT_DEC.ToString("d")), new SwitchPosition("0.0", "Mid", tedac_commands.TDU_BRT_INC.ToString("d")), new SwitchPosition("-1.0", "Inc", tedac_commands.TDU_BRT_INC.ToString("d")) }, "TEDAC", "BRT Rocker Switch", "%0.1f"));
            AddFunction(new Switch(this, TEDAC, "157", new SwitchPosition[] { new SwitchPosition("1.0", "Dec", tedac_commands.TDU_CON_DEC.ToString("d")), new SwitchPosition("0.0", "Mid", tedac_commands.TDU_CON_INC.ToString("d")), new SwitchPosition("-1.0", "Inc", tedac_commands.TDU_CON_INC.ToString("d")) }, "TEDAC", "CON Rocker Switch", "%0.1f"));
            AddFunction(new Switch(this, TEDAC, "147", new SwitchPosition[] { new SwitchPosition("1.0", "Down", tedac_commands.TDU_RF_DOWN.ToString("d")), new SwitchPosition("0.0", "Mid", tedac_commands.TDU_RF_UP.ToString("d")), new SwitchPosition("-1.0", "Up", tedac_commands.TDU_RF_UP.ToString("d")) }, "TEDAC", "R/F Rocker Switch", "%0.1f"));
            AddFunction(new Switch(this, TEDAC, "146", new SwitchPosition[] { new SwitchPosition("1.0", "Down", tedac_commands.TDU_EL_DOWN.ToString("d")), new SwitchPosition("0.0", "Mid", tedac_commands.TDU_EL_UP.ToString("d")), new SwitchPosition("-1.0", "Up", tedac_commands.TDU_EL_UP.ToString("d")) }, "TEDAC", "EL Adjust Rocker Switch", "%0.1f"));
            AddFunction(new Switch(this, TEDAC, "163", new SwitchPosition[] { new SwitchPosition("1.0", "Left", tedac_commands.TDU_AZ_LEFT.ToString("d")), new SwitchPosition("0.0", "Mid", tedac_commands.TDU_AZ_RIGHT.ToString("d")), new SwitchPosition("-1.0", "Right", tedac_commands.TDU_AZ_RIGHT.ToString("d")) }, "TEDAC", "AZ Adjust Rocker Switch", "%0.1f"));
            ...
            AddFunction(new Axis(this, TEDAC, tedac_commands.TDU_GAIN_KNOB.ToString("d"), "148", 0.1d, 0d, 1d, "TEDAC", "FLIR GAIN Control Knob"));
            AddFunction(new Axis(this, TEDAC, tedac_commands.TDU_LEV_KNOB.ToString("d"), "149", 0.1d, 0d, 1d, "TEDAC", "FLIR LEV Control Knob"));
            AddFunction(Switch.CreateThreeWaySwitch(this, TEDAC, tedac_commands.TDU_MODE_KNOB.ToString("d"), "154", "1.0", "Day", "0.5", "Night", "0.0", "Off", "TEDAC", "Display Mode Knob", "%0.1f"));
            #endregion
            ...
            AddFunction(new Switch(this, ENGINE_INTERFACE, "317", new SwitchPosition[] { new SwitchPosition("1.0", "IGN ORIDE", engine_commands.Eng1IgnOrideSw.ToString("d")), new SwitchPosition("0.0", "Off", engine_commands.Eng1StartSw.ToString("d")), new SwitchPosition("-1.0", "Start", engine_commands.Eng1StartSw.ToString("d")) }, "Left Console (Pilot)", "No.1 Engine Start Switch", "%0.1f"));
            AddFunction(new Switch(this, ENGINE_INTERFACE, "318", new SwitchPosition[] { new SwitchPosition("1.0", "IGN ORIDE", engine_commands.Eng2IgnOrideSw.ToString("d")), new SwitchPosition("0.0", "Off", engine_commands.Eng2StartSw.ToString("d")), new SwitchPosition("-1.0", "Start", engine_commands.Eng2StartSw.ToString("d")) }, "Left Console (Pilot)", "No.2 Engine Start Switch", "%0.1f"));
            #endregion
            #region CP/G
            ...
            #region Pilot
            AddFunction(new Switch(this, ELEC_INTERFACE, "355", new SwitchPosition[] { new SwitchPosition("1.0", "Gen 1", electric_commands.GEN1_RST_SW.ToString("d")), new SwitchPosition("0.0", "Gen 2", electric_commands.GEN2_RST_SW.ToString("d")), new SwitchPosition("-1.0", "Gen 2", electric_commands.GEN2_RST_SW.ToString("d")) }, "Generator Reset", "Generator Reset Switch", "%0.1f"));
            AddFunction(new Switch(this, ELEC_INTERFACE, "353", new SwitchPosition[] { new SwitchPosition("1.0", "Eng 2", engine_commands.ChkOvspTestSwENG2A.ToString("d")), new SwitchPosition("0.0", "Eng 1", engine_commands.ChkOvspTestSwENG1A.ToString("d")), new SwitchPosition("-1.0", "Eng 1", engine_commands.ChkOvspTestSwENG1A.ToString("d")) }, "Generator Reset", "CKT A Check Overspeed Test", "%0.1f"));
            AddFunction(new Switch(this, ELEC_INTERFACE, "354", new SwitchPosition[] { new SwitchPosition("1.0", "Eng 2", engine_commands.ChkOvspTestSwENG2B.ToString("d")), new SwitchPosition("0.0", "Eng 1", engine_commands.ChkOvspTestSwENG1B.ToString("d")), new SwitchPosition("-1.0", "Eng 1", engine_commands.ChkOvspTestSwENG1B.ToString("d")) }, "Generator Reset", "CKT B Check Overspeed Test", "%0.1f"));
            #endregion
            #endregion
            #region Handgrip
            #region CP/G
