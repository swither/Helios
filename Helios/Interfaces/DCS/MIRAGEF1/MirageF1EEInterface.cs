...
namespace GadrocsWorkshop.Helios.Interfaces.DCS.MIRAGEF1.EE
{
    ...
    public class MirageF1CEInterface : MirageF1Interface
    {
            ...
            "pack://application:,,,/Helios;component/Interfaces/DCS/MIRAGEF1/ExportFunctionsMirageF1EE.lua")
        {
            ...
            AddFunction(new Switch(this, "1", "1254", new SwitchPosition[] { new SwitchPosition("0.0", "1", "3655"), new SwitchPosition("1.0", "2", "3655") }, "Navigation indicator", "Gyromagnetic/True IDN heading selector", "%0.1f"));
            AddFunction(new Switch(this, "1", "1255", new SwitchPosition[] { new SwitchPosition("0.0", "1", "3656"), new SwitchPosition("1.0", "2", "3656") }, "Navigation indicator", "VOR/Radar narrow needle selector", "%0.1f"));
            AddFunction(new Switch(this, "1", "1256", SwitchPositions.Create(6, 0d, 0.2d, "3657", "Position"), "Navigation indicator", "Mode selector switch", "%0.1f"));
            AddFunction(new Switch(this, "1", "1257", new SwitchPosition[] { new SwitchPosition("-1.0", "1", "3659", "3659", "0.0"), new SwitchPosition("1.0", "2", "3660", "3660", "0.0") }, "Navigation indicator", "Additional vector bearing/distance adjustment switch", "%0.1f"));
            #endregion Navigation indicator
            #region In-flight refuelling system
            AddFunction(new Switch(this, "1", "400", new SwitchPosition[] { new SwitchPosition("0.0", "1", "3664"), new SwitchPosition("1.0", "2", "3664") }, "In-flight refuelling system", "Transfer/filling switch guard", "%0.1f"));
            AddFunction(new Switch(this, "1", "401", new SwitchPosition[] { new SwitchPosition("1.0", "1", "3663"), new SwitchPosition("0.0", "2", "3663") }, "In-flight refuelling system", "Transfer/filling switch", "%0.1f"));
            ...
            AddFunction(new Switch(this, "1", "665", SwitchPositions.Create(6, 0d, 0.1d, "3680", "Position"), "Inertial Navigation System (INS)", "Parameters selector", "%0.1f"));
            AddFunction(new Switch(this, "1", "666", SwitchPositions.Create(9, 0d, 0.125d, "3681", "Position"), "Inertial Navigation System (INS)", "Modes selector", "%0.1f"));
            AddFunction(new Switch(this, "1", "667", SwitchPositions.Create(10, 0d, 0.111d, "3682", "Position"), "Inertial Navigation System (INS)", "Waypoints selecting wheel", "%0.1f"));
            AddFunction(new Switch(this, "1", "668", SwitchPositions.Create(3, 0d, 0.5d, "3683", "Position"), "Inertial Navigation System (INS)", "Lights test and brightness selector", "%0.1f"));
