...
namespace GadrocsWorkshop.Helios.Interfaces.DCS.MiG21
{
    ...
    public class MiG21Interface : DCSInterface
    {
            ...
            : base("DCS MiG-21Bis", "MiG-21Bis", "pack://application:,,,/MiG-21;component/Interfaces/ExportFunctions.lua")
        {
            ...
            AddFunction(Switch.CreateToggleSwitch(this, WEAPON_CONTROL, TAKT_SBROS_SAFETY_COVER, "277", "1", "On", "0", "Off", "Weapon Control", "Tactical Drop Cover", "%1d"));
            ...
            // this argument (595) is correct according to mainpanel_init.lua but does not produce any data.  It is not suprising if the helmet does not work as a clickable cockpit item.
            AddFunction(Switch.CreateToggleSwitch(this, HELMET_VISOR, HELMET_VISOR_EXTRA, "595", "1", "On", "0", "Off", "Helmet Visor", "Helmet visor - off/on", "%1d"));
            #endregion
