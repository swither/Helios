...
if argCount = 0  then
   ...
   RemoveProblemComponent database, "SYSTEM~1.DLL|System.IO.Compression.dll"
   RemoveProblemComponent database, "SYSTEM~2.DLL|System.IO.Compression.dll"
...
Sub RemoveProblemComponent(database, fileName)
    ...
    Else
    	Wscript.Echo  "* * * Info: Component " & fileName & " was not found and not deleted."
    End If
end Sub
