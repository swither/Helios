...
namespace GadrocsWorkshop.Helios.Gauges.F_16.RPM
{
    ...
    [HeliosControl("Helios.F16.RPM", "RPM", "F-16", typeof(GaugeRenderer), HeliosControlFlags.NotShownInUI)]
    public class RPM : BaseGauge
    {
            ...
            : base("RPM", new Size(360, 360))
        {
            ...
            Components.Add(new GaugeImage("{F-16C}/Gauges/RPM/rpm_faceplate.xaml", new Rect(30d, 30d, 300d, 300d)));

            _needle = new GaugeNeedle("{F-16C}/Gauges/RPM/rpm_needle.xaml", new Point(180d, 180d), new Size(60d, 144d), new Point(30d, 114d));
