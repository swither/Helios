...
namespace GadrocsWorkshop.Helios.Gauges.F_16.Trim
{
    ...
    [HeliosControl("Helios.F16.PitchTrim", "Pitch Trim", "F-16", typeof(GaugeRenderer), HeliosControlFlags.NotShownInUI)]
    public class PitchTrim : BaseGauge
    {
            ...
            : base("Trim", new Size(200, 100))
        {
            ...
            Components.Add(new GaugeImage("{F-16C}/Gauges/Trim/pitchtrim_faceplate.xaml", new Rect(0d, 0d, 200d, 100d)));

            _needle = new GaugeNeedle("{F-16C}/Gauges/Trim/pitchtrim_needle.xaml", new Point(100d, 7d), new Size(14d, 90d), new Point(7d, 7d));
