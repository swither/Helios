...
namespace GadrocsWorkshop.Helios.Gauges.F_16.Trim
{
    ...
    [HeliosControl("Helios.F16.RollTrim", "Roll Trim", "F-16", typeof(GaugeRenderer),HeliosControlFlags.NotShownInUI)]
    public class RollTrim : BaseGauge
    {
            ...
            : base("Trim", new Size(100, 200))
        {
            ...
            Components.Add(new GaugeImage("{F-16C}/Gauges/Trim/rolltrim_faceplate.xaml", new Rect(0d, 0d, 100d, 200d)));

            _needle = new GaugeNeedle("{F-16C}/Gauges/Trim/rolltrim_needle.xaml", new Point(93d, 100d), new Size(90d, 14d), new Point(83d, 7d));
