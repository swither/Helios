...
{
    [HeliosControl("F16.MFD", "MFD", "F-16", typeof(BackgroundImageRenderer),HeliosControlFlags.NotShownInUI)]
    class MFD_F16 : Gauges.MFD
    {
        ...
        {
            get { return "{F-16C}/Images/mfd_bezel.png"; }
        }
        ...
        private void AddButton(string name, double x, double y)
        {
            ...
            button.Image = "{F-16C}/Images/mfd-out.png";
            button.PushedImage = "{F-16C}/Images/mfd-in.png";
        ...
        private void AddRocker(string name, string imagePrefix, double x, double y, bool horizontal)
        {
            ...
            rocker.PositionTwoImage = "{F-16C}/Images/" + imagePrefix + "-middle.png";
            ...
            if (horizontal)
            {
                ...
                rocker.PositionOneImage = "{F-16C}/Images/" + imagePrefix + "-left.png";
                rocker.PositionThreeImage = "{F-16C}/Images/" + imagePrefix + "-right.png";
                rocker.Width = 56;
                rocker.Height = 32;
            }
            else
            {
                ...
                rocker.PositionOneImage = "{F-16C}/Images/" + imagePrefix + "-up.png";
                rocker.PositionThreeImage = "{F-16C}/Images/" + imagePrefix + "-down.png";
                rocker.Width = 32;
                rocker.Height = 56;
            }
