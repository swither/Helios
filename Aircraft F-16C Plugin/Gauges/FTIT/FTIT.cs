...
namespace GadrocsWorkshop.Helios.Gauges.F_16.FTIT
{
    ...
    [HeliosControl("Helios.F16.FTIT", "FTIT", "F-16", typeof(GaugeRenderer), HeliosControlFlags.NotShownInUI)]
    public class FTIT : BaseGauge
    {
            ...
            : base("FTIT", new Size(360, 360))
        {
            ...
            Components.Add(new GaugeImage("{F-16C}/Gauges/FTIT/ftit_faceplate.xaml", new Rect(30d, 30d, 300d, 300d)));

            _needle = new GaugeNeedle("{F-16C}/Gauges/FTIT/ftit_needle.xaml", new Point(180d, 180d), new Size(60d, 144d), new Point(30d, 114d), 90d);
