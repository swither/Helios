...
namespace GadrocsWorkshop.Helios.Gauges.F_16.Airspeed
{
    ...
    [HeliosControl("Helios.F16.Airspeed", "Airspeed", "F-16", typeof(GaugeRenderer), HeliosControlFlags.NotShownInUI)]
    public class Airspeed : BaseGauge
    {
        ...
        {
            Components.Add(new GaugeImage("{F-16C}/Gauges/Airspeed/asi_faceplate.xaml", new Rect(32d, 38d, 300d, 300d)));
            ...
            _machRing = new GaugeNeedle("{F-16C}/Gauges/Airspeed/asi_inner_faceplate.xaml", new Point(182d, 188d), new Size(188d, 188d), new Point(94d, 94d), -90d);
            ...
            _needle = new GaugeNeedle("{F-16C}/Gauges/Airspeed/asi_needle.xaml", new Point(182d, 188d), new Size(300d, 300d), new Point(150d, 150d), -90d);
