...
#pragma warning restore CS0649
        ...
        public FuelFlow(BaseUDPInterface sourceInterface) : this(sourceInterface, "2091", "Fuel System", "Fuel Flow", "Fuel Flow rate.") { }    
        public FuelFlow(BaseUDPInterface sourceInterface, string arg, string device, string elementName, string description)
        ...
        public FuelFlow(BaseUDPInterface sourceInterface, System.Runtime.Serialization.StreamingContext context)
        ...
        private void DoBuild()
        {
            _fuel = new HeliosValue(SourceInterface, BindingValue.Empty, SerializedDeviceName, SerializedFunctionName,
                SerializedDescription, "", BindingValueUnits.PoundsPerHour);
            Values.Add(_fuel);
            Triggers.Add(_fuel);
        }
