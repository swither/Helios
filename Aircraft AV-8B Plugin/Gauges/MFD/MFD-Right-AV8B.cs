...
namespace GadrocsWorkshop.Helios.Gauges.AV8B
{
    ...
    /// <summary>
    /// This is the revised version of the Right MDFD which is larger with improved images.  
    ...
    /// </summary>
    /// 
    [HeliosControl("AV8B.MPCDR", "MPCD (Right)", "AV-8B Harrier", typeof(BackgroundImageRenderer), HeliosControlFlags.NotShownInUI)]
