...
namespace GadrocsWorkshop.Helios.Gauges.AV8B
{
    ...
    [HeliosControl("Helios.AV8B.ClockFace", "Clock Face", "AV-8B Harrier", typeof(GaugeRenderer),HeliosControlFlags.NotShownInUI)]
    public class ClockFace : BaseGauge
    {
            ...
            : base("Clock", new Size(390, 390))
        {
            ...
            Components.Add(new GaugeImage("{AV-8B}/Gauges/Clock/clock_faceplate.xaml", new Rect(0d, 0d, 394d, 394d)));
            _clockHoursNeedle = new GaugeNeedle("{AV-8B}/Gauges/Clock/hours_needle.xaml", center, new Size(25d, 125d), new Point(12.5d, 112.5d));
