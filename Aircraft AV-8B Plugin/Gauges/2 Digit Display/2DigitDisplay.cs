...
namespace GadrocsWorkshop.Helios.Gauges.AV8B
{
    ...
    [HeliosControl("Helios.AV8B.TwoDigitDisplay", "Two Digit Display", "AV-8B Gauges", typeof(GaugeRenderer), HeliosControlFlags.NotShownInUI)]
    public class TwoDigitDisplay : BaseGauge
    {
        ...
        {
            Components.Add(new GaugeImage("{AV-8B}/Gauges/2 Digit Display/digit_faceplate.xaml", new Rect(0d, 0d, 147d, 100d)));

            _tensDrum = new GaugeDrumCounter("{AV-8B}/Gauges/Common/drum_tape.xaml", new Point(13.5d, 11.5d), "#", new Size(10d, 15d), new Size(50d, 75d));
            _tensDrum.Clip = new RectangleGeometry(new Rect(13.5d, 11.5d, 50d, 75d));
            Components.Add(_tensDrum);

            _onesDrum = new GaugeDrumCounter("{AV-8B}/Gauges/Common/drum_tape.xaml", new Point(79.5d, 11.5d), "#", new Size(10d, 15d), new Size(50d, 75d));
