...
namespace GadrocsWorkshop.Helios.Gauges.AV8B
{
    ...
    [HeliosControl("Helios.AV8B.IAS", "AV-8B Airspeed", "AV-8B Harrier", typeof(GaugeRenderer), HeliosControlFlags.NotShownInUI)]
    public class IAS : BaseGauge
    {
            ...
            : base("Flight Instruments", new Size(300, 300))
        {
            ...
            Components.Add(new GaugeImage("{AV-8B}/Gauges/IAS/ias_faceplate.xaml", new Rect(0d, 0d, 300, 300)));
            ...
            _needle = new GaugeNeedle("{AV-8B}/Gauges/Common/needle_a.xaml", new Point(150d, 150d), new Size(30, 128), new Point(15, 113), 0d);
            Components.Add(_needle);

            //Components.Add(new GaugeImage("{Helios}/Gauges/A-10/Common/gauge_bezel.png", new Rect(0d, 0d, 364d, 376d)));
            Components.Add(new GaugeImage("{AV-8B}/Gauges/IAS/needle_mask.xaml", new Rect(130d, 34d, 73d, 98d)));
