...
namespace GadrocsWorkshop.Helios.Gauges.AV8B
{
    ...
    [HeliosControl("Helios.AV8B.AoA", "AV-8B Angle of Attack", "AV-8B Harrier", typeof(GaugeRenderer), HeliosControlFlags.NotShownInUI)]
    public class AOA : BaseGauge
    {
        ...
        {
            Components.Add(new GaugeImage("{AV-8B}/Gauges/Common/300_Gauge.xaml", new Rect(0d, 0d, 300d, 300d)));
            ...
            _warningFlagNeedle = new GaugeNeedle("{AV-8B}/Gauges/AOA/aoa_off_flag.xaml", new Point(20d, 248d), new Size(70d, 90d), new Point(0d, 178d), 0d);
            ...
            Components.Add(new GaugeImage("{AV-8B}/Gauges/AOA/aoa_faceplate.xaml", new Rect(0d, 0d, 300d, 300d)));
