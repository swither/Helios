...
namespace GadrocsWorkshop.Helios.Gauges.AV8B.SlipBall
{
    ...
    [HeliosControl("Helios.AV8B.SlipTurn", "AV-8B Slip Turn Indicator", "AV-8B Harrier", typeof(GaugeRenderer), HeliosControlFlags.NotShownInUI)]
    public class SlipTurn : BaseGauge
    {
            ...
            : base("SlipTurn", new Size(225, 114))
        {
            ...
            Components.Add(new GaugeImage("{AV-8B}/Gauges/ADI/adi_slip_bezel.png", new Rect(0d, 0d, 225d, 114d)));

            _slipBallCalibration = new CalibrationPointCollectionDouble(-1d, -50d, 1d, 50d);
            _slipBallNeedle = new GaugeNeedle("{AV-8B}/Gauges/ADI/adi_slip_ball.xaml", new Point(112d, 75d), new Size(24d, 24d), new Point(12d, 12d));
            _TurnMarker = new GaugeNeedle("{AV-8B}/Gauges/ADI/adi_turn_marker.xaml", new Point(112d, 38d), new Size(14d, 18d), new Point(7d, 9d));
            Components.Add(_slipBallNeedle);
            Components.Add(_TurnMarker);

            _warningFlagNeedle = new GaugeNeedle("{AV-8B}/Gauges/AOA/aoa_off_flag.xaml", new Point(80d, 20d), new Size(28d, 36d), new Point(0d, 0d), 0d);
            Components.Add(_warningFlagNeedle);


            Components.Add(new GaugeImage("{AV-8B}/Gauges/ADI/adi_slip_guides.xaml", new Rect(0d, 0d, 225d, 114d)));
