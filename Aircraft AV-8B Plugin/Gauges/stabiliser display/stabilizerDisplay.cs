...
namespace GadrocsWorkshop.Helios.Gauges.AV8B
{
    ...
    public class StabilizerDisplay : BaseGauge
    {
        ...
        {
            //Components.Add(new GaugeImage("{AV-8B}/Gauges/stabilizer display/digit_faceplate.xaml", new Rect(0d, 0d, 80d, 100d)));

            _onesDrum = new GaugeDrumCounter("{AV-8B}/Gauges/stabiliser display/stabilizer_drum_tape.xaml", position, "#", new Size(8d, 10d), size);
