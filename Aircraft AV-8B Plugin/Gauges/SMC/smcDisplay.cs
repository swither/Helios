...
namespace GadrocsWorkshop.Helios.Gauges.AV8B
{
    ...
    public class smcModeDisplay : BaseGauge
    {
        ...
        {
            //sComponents.Add(new GaugeImage("{AV-8B}/Gauges/SMC/DelModedigit_faceplate.xaml", new Rect(0d, 0d, 180d, 100d)));

            _onesDrum = new GaugeDrumCounter("{AV-8B}/Gauges/SMC/stores_mode_drum_tape.xaml", new Point(0d, 0d), "#", new Size(18d, 10d), new Size(90d, 50d));
