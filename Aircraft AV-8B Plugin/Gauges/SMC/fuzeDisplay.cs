...
namespace GadrocsWorkshop.Helios.Gauges.AV8B
{
    ...
    [HeliosControl("Helios.AV8B.fuzeDisplay", "SMC Fuze Display", "AV-8B Harrier", typeof(GaugeRenderer), HeliosControlFlags.NotShownInUI)]
    public class fuzeDisplay : BaseGauge
    {
        ...
        {
            //Components.Add(new GaugeImage("{AV-8B}/Gauges/SMC/fuze_digit_faceplate.xaml", new Rect(0d, 0d, 140d, 50d)));

            _leftDrum = new GaugeDrumCounter("{AV-8B}/Gauges/SMC/fuze_mode_drum_tape_left.xaml", new Point(0d, 0d), "#", new Size(100d,100d), new Size(50d,50d));
            _leftDrum.Clip = new RectangleGeometry(new Rect(0d, 0d, 50d, 50d));
            Components.Add(_leftDrum);
            _rightDrum = new GaugeDrumCounter("{AV-8B}/Gauges/SMC/fuze_mode_drum_tape_right.xaml", new Point(60d, 0d), "#", new Size(100d, 100d), new Size(50d, 50d));
