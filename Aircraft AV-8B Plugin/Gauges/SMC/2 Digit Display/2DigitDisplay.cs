...
namespace GadrocsWorkshop.Helios.Gauges.AV8B.SMC
{
    ...
    [HeliosControl("Helios.AV8B.SMC.TwoDigitDisplay", "Two Digit Display", "AV-8B Gauges", typeof(GaugeRenderer), HeliosControlFlags.NotShownInUI)]
    public class TwoDigitDisplay : BaseGauge
    {
        ...
        {
            Components.Add(new GaugeImage("{AV-8B}/Gauges/SMC/2 Digit Display/digit_faceplate.xaml", new Rect(0d, 0d, 196d, 96d)));

            _tensDrum = new GaugeDrumCounter("{AV-8B}/Gauges/Common/drum_tape.xaml", new Point(9d, 2d), "#", new Size(10d, 15d), new Size(64d, 96d));
            _tensDrum.Clip = new RectangleGeometry(new Rect(9d, 2d, 64d, 96d));
            Components.Add(_tensDrum);

            _onesDrum = new GaugeDrumCounter("{AV-8B}/Gauges/Common/drum_tape.xaml", new Point(122d, 2d), "#", new Size(10d, 15d), new Size(64d, 96d));
