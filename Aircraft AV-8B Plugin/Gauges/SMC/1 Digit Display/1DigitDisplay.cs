...
namespace GadrocsWorkshop.Helios.Gauges.AV8B.SMC
{
    ...
    [HeliosControl("Helios.AV8B.SMC.OneDigitDisplay", "One Digit Display", "AV-8B Gauges", typeof(GaugeRenderer), HeliosControlFlags.NotShownInUI)]
    public class OneDigitDisplay : BaseGauge
    {
        ...
        {
            Components.Add(new GaugeImage("{AV-8B}/Gauges/SMC/1 Digit Display/digit_faceplate.xaml", new Rect(0d, 0d, 82d, 96d)));

            _onesDrum = new GaugeDrumCounter("{AV-8B}/Gauges/Common/drum_tape.xaml", new Point(9d, 2d), "#", new Size(10d, 15d), new Size(64d, 96d));
