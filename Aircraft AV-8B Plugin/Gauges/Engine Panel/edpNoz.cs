...
namespace GadrocsWorkshop.Helios.Gauges.AV8B
{
    ...
    [HeliosControl("Helios.AV8B.edpNoz", "EDP Nozzle", "AV-8B Harrier", typeof(GaugeRenderer), HeliosControlFlags.NotShownInUI)]
    public class edpNoz: BaseGauge
    {
        ...
        {
            //Components.Add(new GaugeImage("{AV-8B}/Gauges/Engine Panel/edp_faceplate.xaml", new Rect(0d, 0d, 528d, 302d)));
            _needleCalibration = new CalibrationPointCollectionDouble(0d, 0d, 0.94d, 130d);
            _needle = new GaugeNeedle("{AV-8B}/Gauges/Engine Panel/nozzle_needle.xaml", new Point(0d, 0d), new Size(12d, 48d), new Point(6d, 42d), 90d);
