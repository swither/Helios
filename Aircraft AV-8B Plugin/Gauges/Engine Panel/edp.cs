...
namespace GadrocsWorkshop.Helios.Gauges.AV8B
{
    ...
    [HeliosControl("Helios.AV8B.EDP", "Engine Panel", "AV-8B Harrier", typeof(BackgroundImageRenderer), HeliosControlFlags.NotShownInUI)]
    class EDP: AV8BDevice
    {
        ...
        private void AddIndicator(string name, Point posn, Size size, bool _vertical, string interfaceElementName)
        {
            Indicator indicator = AddIndicator(
                ...
                posn: posn,
                size: size,
                onImage: "{AV-8B}/Gauges/Engine Panel/edp_water_light.xaml",
        ...
        {
            get { return "{AV-8B}/Gauges/Engine Panel/edp_faceplate.xaml"; }
        }
    }
}
