...
namespace GadrocsWorkshop.Helios.Gauges.AV8B.Accumulator
{
    ...
    [HeliosControl("Helios.AV8B.Accumulator", "AV-8B Accumulator", "AV-8B Harrier", typeof(GaugeRenderer), HeliosControlFlags.NotShownInUI)]
    public class Accumulator : BaseGauge
    {
            ...
            : base("Accumulator", new Size(304, 304))
        {
            ...
            Components.Add(new GaugeImage("{AV-8B}/Gauges/Accumulator/accumulator_faceplate.xaml", new Rect(0d, 0d, 304d, 304d)));
