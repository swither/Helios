...
namespace GadrocsWorkshop.Helios.Gauges.AV8B
{
    ...
    [HeliosControl("Helios.AV8B.FiveDigitDisplay", "Five Digit Display", "AV-8B Gauges", typeof(GaugeRenderer), HeliosControlFlags.NotShownInUI)]
    public class FiveDigitDisplay : BaseGauge
    {
        ...
        {
            Components.Add(new GaugeImage("{AV-8B}/Gauges/5 Digit Display/digit_faceplate.xaml", new Rect(0d, 0d, 339d, 100d)));
