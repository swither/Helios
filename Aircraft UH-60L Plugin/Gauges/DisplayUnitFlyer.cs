...
namespace GadrocsWorkshop.Helios.Gauges.UH60L.Instruments.DisplayUnit
{
    ...
    [HeliosControl("Helios.UH60L.FlyerDisplayUnit", "Flyer Display Unit", "UH-60L Blackhawk", typeof(BackgroundImageRenderer), HeliosControlFlags.NotShownInUI)]
    public class FlyerDisplayUnit : CompositeVisualWithBackgroundImage
    {
            ...
            : base($"{flyer} Display Unit", new Size(492, 840))
        {
            ...
            AddBarGauge("RPM Engine 1", new Point(59, 50), new Size(40, 738), 41d, "{UH-60L}/Images/SegmentBarDisplay41RPM.xaml", _interfaceDeviceName, "Engine 1 RPM");
            AddBarGauge("RPM Rotor", new Point(119, 50), new Size(40, 738), 41d, "{UH-60L}/Images/SegmentBarDisplay41RPM.xaml", _interfaceDeviceName, "Rotor RPM");
            AddBarGauge("RPM Engine 2", new Point(179, 50), new Size(40, 738), 41d, "{UH-60L}/Images/SegmentBarDisplay41RPM.xaml", _interfaceDeviceName, "Engine 2 RPM");
            AddBarGauge("Torque Engine 1", new Point(358, 50), new Size(20, 540), 30d, "{UH-60L}/Images/SegmentBarDisplay30Torque.xaml", _interfaceDeviceName, "Engine 1 Torque");
            AddBarGauge("Torque Engine 2", new Point(409, 50), new Size(20, 540), 30d, "{UH-60L}/Images/SegmentBarDisplay30Torque.xaml", _interfaceDeviceName, "Engine 2 Torque");
        }
        ...
        {
            get { return "{UH-60L}/Images/FlyerDisplayUnitBackground.xaml"; }
        }
