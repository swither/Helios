...
namespace GadrocsWorkshop.Helios.Gauges.UH60L.Instruments
{
    ...
    [HeliosControl("Helios.UH60L.Stabilator.Indicator", "Stabilator Position Instrument", "UH-60L Blackhawk", typeof(GaugeRenderer),HeliosControlFlags.NotShownInUI)]
    public class StabInstrument : BaseGauge
    {
            ...
            : base(name, size)
        {
            ...
            Components.Add(new GaugeImage("{UH-60L}/Images/StabScale.xaml", new Rect(0d, 0d, 276d, 233d)));
            ...
            _needle = new GaugeNeedle("{UH-60L}/Images/StabNeedle.xaml", new Point(77d, 81d), new Size(171d, 28d), new Point(14d, 14d), 0d);
            ...
            _offFlagNeedle = new GaugeNeedle("{UH-60L}/Images/StabOffFlag.xaml", new Point(77d, 81d), new Size(25d, 59d), new Point(0d, -80d), -20d);
            ...
            Components.Add(new GaugeImage("{UH-60L}/Images/StabSurface.xaml", new Rect(0d, 0d, 276d, 233d)));
