...
namespace GadrocsWorkshop.Helios.Gauges.UH60L.Instruments
{
    ...
    [HeliosControl("Helios.UH60L.RadAlt.Copilot", "RADAR Altimeter (Copilot)", "UH-60L Blackhawk", typeof(BackgroundImageRenderer), HeliosControlFlags.NotShownInUI)]
    public class RadAltCopilot : RadAlt
    {
