...
namespace GadrocsWorkshop.Helios.Gauges.UH60L.Chronometer
{
    ...
    [HeliosControl("Helios.UH60L.Chronometer.Copilot", "Chronometer Display (Copilot)", "UH-60L Blackhawk", typeof(BackgroundImageRenderer), HeliosControlFlags.NotShownInUI)]
