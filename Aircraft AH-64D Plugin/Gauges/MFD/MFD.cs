...
namespace GadrocsWorkshop.Helios.Gauges.AH64D.MFD
{
    ...
    public class MFD : CompositeVisualWithBackgroundImage
    {
            ...
            : base(interfaceDevice, new Size(1469 / 2, 1381 / 2))
        {
            ...
            _frameBezelPanel = AddPanel("MFD Frame", new Point(Left, Top), NativeSize, "{AH-64D}/Images/MFD/MFD_Frame.png", _interfaceDevice);
        ...
        public override string DefaultBackgroundImage => "{AH-64D}/Images/MFD/MFD_Frame.png";
