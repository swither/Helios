...
namespace GadrocsWorkshop.Helios.Gauges.AH64D.KU
{
    ...
    public class KU : CompositeVisualWithBackgroundImage
    {
        ...
        private const string Panel_Image = "{AH-64D}/Images/KU/KU_Frame.png";
            ...
            : base(interfaceDevice, new Size(600, 465))
        {
            ...
            _frameBezelPanel = AddPanel("KU Frame", new Point(Left, Top), NativeSize, "{AH-64D}/Images/KU/KU_Frame.png", _interfaceDevice);
        ...
        private void AddButton(string name, Rect rect, string label)
        {
            ...
            string image = (label == "N" || label == "S" || label == "E" || label == "W") ? $"{{AH-64D}}/Images/KU/tactile-dark-{shape}-emphasised" : $"{{Helios}}/Images/Buttons/tactile-dark-{shape}";
            switch (label)
            {
                case "+/-":
                    label = "±";
