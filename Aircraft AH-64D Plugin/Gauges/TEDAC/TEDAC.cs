...
namespace GadrocsWorkshop.Helios.Gauges.AH64D.TEDAC
{
    ...
    public class TEDAC : CompositeVisualWithBackgroundImage
    {
            ...
            : base("TEDAC", new Size(1089, 1080))
        {
            ...
            _frameBezelPanel = AddPanel("TEDAC Frame", new Point(Left, Top), NativeSize, "{AH-64D}/Images/TEDAC/TEDAC_frame.png", _interfaceDevice);
        ...
        private void AddButton(string name, Rect rect, bool horizontal, string label)
        {
            ...
            if (label != "")
            {
                button.Image = "{AH-64D}/Images/MFD/MFD Button 2 UpH.png";
                button.PushedImage = "{AH-64D}/Images/MFD/MFD Button 2 DnH.png";
            ...
            {
                button.Image = "{AH-64D}/Images/MFD/MFD Button 1 UpH.png";
                button.PushedImage = "{AH-64D}/Images/MFD/MFD Button 1 DnH.png";
            }
            button.TextFormat.ConfiguredFontSize = button.TextFormat.FontSize;
        ...
        private void AddThreePositionRotarySwitch(string name, Point posn, Size size, string interfaceDeviceName, string interfaceElementName)
        {
            ...
            knob.KnobImage = "{AH-64D}/Images/Common/Common Knob.png";
        ...
        public override string DefaultBackgroundImage => "{AH-64D}/Images/TEDAC/TEDAC_frame.png";
