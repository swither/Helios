...
namespace GadrocsWorkshop.Helios.Gauges.AH64D.CMWS
{
    ...
    public class CMWSDisplay : CompositeVisualWithBackgroundImage
    {
            ...
            : base("CMWS Display", new Size(640, 409))
        {
            ...
            _displayBackgroundPanel = AddPanel("CMWS Display Background", new Point(206, 29), new Size(230, 110), "{AH-64D}/Images/CMWS/cmws_background.xaml", _interfaceDeviceName);
            ...
            _frameBezelPanel = AddPanel("CMWS Frame", new Point(Left, Top), NativeSize, "{AH-64D}/Images/CMWS/cmws_frame.png", _interfaceDeviceName);
            ...
            AddTwoWayGuardToggle("Flare Jettison", new Point(472d, 191d), new Size(81d, 220d), _interfaceDeviceName, "Flare Jettison Switch", "Jettison Switch Cover", "{AH-64D}/Images/CMWS/CMWS_Jettison_");
        }
    ...
    string interfaceDeviceName, string interfaceElementName, double baseFontsize, string testDisp, TextHorizontalAlignment hTextAlign, string devDictionary)
        ...
        private void AddThreePositionRotarySwitch(string name, Point posn, Size size, string interfaceDeviceName, string interfaceElementName)
        {
            ...
            knob.KnobImage = "{AH-64D}/Images/Common/Selector_Knob.png";
