...
namespace GadrocsWorkshop.Helios.Gauges.AH64D.CMWS
{
    ...
    public class CMWSThreatDisplay : BaseGauge
    {
            ...
            : base("CMWS Threat Display", new Size(350, 350))
        {
            ...
            _arrowBackgroundImage = new GaugeImage("{AH-64D}/Images/CMWS/cmws_threat_background.xaml", new Rect(arrowDisplayX, arrowDisplayY,NativeSize.Width, NativeSize.Height));
            _arrowBackgroundImage.IsHidden = false;
            Components.Add(_arrowBackgroundImage);

            _readyFlagImage = new GaugeImage("{AH-64D}/Images/CMWS/cmws_r.xaml", new Rect(arrowDisplayX, arrowDisplayY,NativeSize.Width, NativeSize.Height));
            ...
            _dispensingFlagImage = new GaugeImage("{AH-64D}/Images/CMWS/cmws_d.xaml", new Rect(arrowDisplayX, arrowDisplayY,NativeSize.Width, NativeSize.Height));
            ...
            _threatDirectionFrontLeftImage = new GaugeImage("{AH-64D}/Images/CMWS/cmws_topleft.xaml", new Rect(arrowDisplayX, arrowDisplayY,NativeSize.Width, NativeSize.Height));
            ...
            _threatDirectionFrontRightImage = new GaugeImage("{AH-64D}/Images/CMWS/cmws_topright.xaml", new Rect(arrowDisplayX, arrowDisplayY,NativeSize.Width, NativeSize.Height));
            ...
            _threatDirectionAftLeftImage = new GaugeImage("{AH-64D}/Images/CMWS/cmws_bottomleft.xaml", new Rect(arrowDisplayX, arrowDisplayY,NativeSize.Width, NativeSize.Height));
            ...
            _threatDirectionAftRightImage = new GaugeImage("{AH-64D}/Images/CMWS/cmws_bottomright.xaml", new Rect(arrowDisplayX, arrowDisplayY,NativeSize.Width, NativeSize.Height));
            ...
            _threatArrowFrontImage = new GaugeImage("{AH-64D}/Images/CMWS/cmws_front.xaml", new Rect(arrowDisplayX, arrowDisplayY,NativeSize.Width, NativeSize.Height));
            ...
            _threatArrowLeftImage = new GaugeImage("{AH-64D}/Images/CMWS/cmws_left.xaml", new Rect(arrowDisplayX, arrowDisplayY,NativeSize.Width, NativeSize.Height));
            ...
            _threatArrowAftImage = new GaugeImage("{AH-64D}/Images/CMWS/cmws_rear.xaml", new Rect(arrowDisplayX, arrowDisplayY,NativeSize.Width, NativeSize.Height));
            ...
            _threatArrowRightImage = new GaugeImage("{AH-64D}/Images/CMWS/cmws_right.xaml", new Rect(arrowDisplayX, arrowDisplayY,NativeSize.Width, NativeSize.Height));
