...
namespace GadrocsWorkshop.Helios.Gauges.Falcon.ICP
{
	...
	[HeliosControl("Helios.Falcon.ICP", "Falcon BMS ICP", "Falcon BMS F-16", typeof(GaugeRenderer))]
	public class ICP : BaseGauge
	{
		...
		private const string _backplateOffImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_backplate_off.xaml";
		private const string _backplateDimImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_backplate_dim.xaml";
		private const string _backplateBrtImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_backplate_brt.xaml";
		private const string _faceplateOffImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_faceplate_off.png";
		private const string _faceplateLitImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_faceplate_lit.png";
		private const string _buttonCOMM1Image = "{HeliosFalcon}/Gauges/F-16/ICP/icp_comm1.png";
		private const string _buttonCOMM1PressImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_comm1_press.png";
		private const string _buttonCOMM2Image = "{HeliosFalcon}/Gauges/F-16/ICP/icp_comm2.png";
		private const string _buttonCOMM2PressImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_comm2_press.png";
		private const string _buttonIFFImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_iff.png";
		private const string _buttonIFFPressImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_iff_press.png";
		private const string _buttonLISTImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_list.png";
		private const string _buttonLISTPressImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_list_press.png";
		private const string _buttonAAImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_a_a.png";
		private const string _buttonAAPressImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_a_a_press.png";
		private const string _buttonAGImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_a_g.png";
		private const string _buttonAGPressImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_a_g_press.png";
		private const string _button01Image = "{HeliosFalcon}/Gauges/F-16/ICP/icp_1.png";
		private const string _button01PressImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_1_press.png";
		private const string _button02Image = "{HeliosFalcon}/Gauges/F-16/ICP/icp_2.png";
		private const string _button02PressImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_2_press.png";
		private const string _button03Image = "{HeliosFalcon}/Gauges/F-16/ICP/icp_3.png";
		private const string _button03PressImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_3_press.png";
		private const string _button04Image = "{HeliosFalcon}/Gauges/F-16/ICP/icp_4.png";
		private const string _button04PressImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_4_press.png";
		private const string _button05Image = "{HeliosFalcon}/Gauges/F-16/ICP/icp_5.png";
		private const string _button05PressImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_5_press.png";
		private const string _button06Image = "{HeliosFalcon}/Gauges/F-16/ICP/icp_6.png";
		private const string _button06PressImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_6_press.png";
		private const string _button07Image = "{HeliosFalcon}/Gauges/F-16/ICP/icp_7.png";
		private const string _button07PressImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_7_press.png";
		private const string _button08Image = "{HeliosFalcon}/Gauges/F-16/ICP/icp_8.png";
		private const string _button08PressImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_8_press.png";
		private const string _button09Image = "{HeliosFalcon}/Gauges/F-16/ICP/icp_9.png";
		private const string _button09PressImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_9_press.png";
		private const string _button00Image = "{HeliosFalcon}/Gauges/F-16/ICP/icp_0.png";
		private const string _button00PressImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_0_press.png";
		private const string _buttonRCLImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_rcl.png";
		private const string _buttonRCLPressImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_rcl_press.png";
		private const string _buttonENTRImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_enter.png";
		private const string _buttonENTRPressImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_enter_press.png";
		private const string _buttonWXImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_wx.png";
		private const string _buttonWXPressImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_wx_press.png";
		private const string _buttonDCSCenterImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_dcs_center.png";
		private const string _buttonDCSUpImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_dcs_up.png";
		private const string _buttonDCSDownImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_dcs_down.png";
		private const string _buttonDCSLeftImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_dcs_left.png";
		private const string _buttonDCSRightImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_dcs_right.png";
		private const string _rockerUpImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_rocker_up.png";
		private const string _rockerCenterImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_rocker_center.png";
		private const string _rockerDownImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_rocker_down.png";
		private const string _wheelUpOffImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_wheel_up_off.png";
		private const string _wheelCenterOffImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_wheel_center_off.png";
		private const string _wheelDownOffImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_wheel_down_off.png";
		private const string _wheelUpLitImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_wheel_up_lit.png";
		private const string _wheelCenterLitImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_wheel_center_lit.png";
		private const string _wheelDownLitImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_wheel_down_lit.png";
		private const string _switchPositionOneImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_switch_up.png";
		private const string _switchPositionTwoImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_switch_center.png";
		private const string _switchPositionThreeImage = "{HeliosFalcon}/Gauges/F-16/ICP/icp_switch_down.png";
