...
namespace GadrocsWorkshop.Helios.Gauges.Falcon.AOA
{
	...
	[HeliosControl("Helios.Falcon.AOA", "Falcon BMS AOA", "Falcon BMS F-16", typeof(GaugeRenderer))]
	public class AOA : BaseGauge
	{
		...
		private const string _backplateImage = "{HeliosFalcon}/Gauges/F-16/Common/aoa_vvi_bezel.png";
		private const string _flagImage = "{HeliosFalcon}/Gauges/F-16/AOA/aoa_off_flag.xaml";
		private const string _faceplateOffImage = "{HeliosFalcon}/Gauges/F-16/AOA/aoa_faceplate_off.xaml";
		private const string _faceplateDimImage = "{HeliosFalcon}/Gauges/F-16/AOA/aoa_faceplate_dim.xaml";
		private const string _faceplateBrtImage = "{HeliosFalcon}/Gauges/F-16/AOA/aoa_faceplate_brt.xaml";
		private const string _tapeOffImage = "{HeliosFalcon}/Gauges/F-16/AOA/aoa_tape_off.xaml";
		private const string _tapeDimImage = "{HeliosFalcon}/Gauges/F-16/AOA/aoa_tape_dim.xaml";
		private const string _tapeBrtImage = "{HeliosFalcon}/Gauges/F-16/AOA/aoa_tape_brt.xaml";
