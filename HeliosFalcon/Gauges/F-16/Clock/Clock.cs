...
namespace GadrocsWorkshop.Helios.Gauges.Falcon.Clock
{
	...
	[HeliosControl("Helios.Falcon.Clock", "Falcon BMS Clock", "Falcon BMS F-16", typeof(GaugeRenderer))]
	public class Clock : BaseGauge
	{
		...
		private const string _faceplateOffImage = "{HeliosFalcon}/Gauges/F-16/Clock/clock_faceplate_off.xaml";
		private const string _faceplateDimImage = "{HeliosFalcon}/Gauges/F-16/Clock/clock_faceplate_dim.xaml";
		private const string _faceplateBrtImage = "{HeliosFalcon}/Gauges/F-16/Clock/clock_faceplate_brt.xaml";
		private const string _needleHoursOffImage = "{HeliosFalcon}/Gauges/F-16/Clock/hour_hand_off.xaml";
		private const string _needleHoursDimImage = "{HeliosFalcon}/Gauges/F-16/Clock/hour_hand_dim.xaml";
		private const string _needleHoursBrtImage = "{HeliosFalcon}/Gauges/F-16/Clock/hour_hand_brt.xaml";
		private const string _needleMinutesOffImage = "{HeliosFalcon}/Gauges/F-16/Clock/minute_hand_off.xaml";
		private const string _needleMinutesDimImage = "{HeliosFalcon}/Gauges/F-16/Clock/minute_hand_dim.xaml";
		private const string _needleMinutesBrtImage = "{HeliosFalcon}/Gauges/F-16/Clock/minute_hand_brt.xaml";
		private const string _needleSecondsOffImage = "{HeliosFalcon}/Gauges/F-16/Clock/second_hand_off.xaml";
		private const string _needleSecondsDimImage = "{HeliosFalcon}/Gauges/F-16/Clock/second_hand_dim.xaml";
		private const string _needleSecondsBrtImage = "{HeliosFalcon}/Gauges/F-16/Clock/second_hand_brt.xaml";
