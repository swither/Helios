...
namespace GadrocsWorkshop.Helios.Gauges.Falcon.Altimeter
{
	...
	public class Altimeter : BaseGauge
	{
		...
		private const string _tensDrumOffImage = "{HeliosFalcon}/Gauges/F-16/Altimeter/alt_drum_tape_off.xaml";
		private const string _tensDrumDimImage = "{HeliosFalcon}/Gauges/F-16/Altimeter/alt_drum_tape_dim.xaml";
		private const string _tensDrumBrtImage = "{HeliosFalcon}/Gauges/F-16/Altimeter/alt_drum_tape_brt.xaml";
		private const string _mainDrumOffImage = "{HeliosFalcon}/Gauges/F-16/Common/drum_tape_off.xaml";
		private const string _mainDrumDimImage = "{HeliosFalcon}/Gauges/F-16/Common/drum_tape_dim.xaml";
		private const string _mainDrumBrtImage = "{HeliosFalcon}/Gauges/F-16/Common/drum_tape_brt.xaml";
		private const string _pressureDrumOffImage = "{HeliosFalcon}/Gauges/F-16/Common/drum_tape_off.xaml";
		private const string _pressureDrumDimImage = "{HeliosFalcon}/Gauges/F-16/Common/drum_tape_dim.xaml";
		private const string _pressureDrumBrtImage = "{HeliosFalcon}/Gauges/F-16/Common/drum_tape_brt.xaml";
		private const string _faceplateOffImage = "{HeliosFalcon}/Gauges/F-16/Altimeter/altimeter_faceplate_off.xaml";
		private const string _faceplateDimImage = "{HeliosFalcon}/Gauges/F-16/Altimeter/altimeter_faceplate_dim.xaml";
		private const string _faceplateBrtImage = "{HeliosFalcon}/Gauges/F-16/Altimeter/altimeter_faceplate_brt.xaml";
		private const string _needleOffImage = "{HeliosFalcon}/Gauges/F-16/Altimeter/altimeter_needle_off.xaml";
		private const string _needleDimImage = "{HeliosFalcon}/Gauges/F-16/Altimeter/altimeter_needle_dim.xaml";
		private const string _needleBrtImage = "{HeliosFalcon}/Gauges/F-16/Altimeter/altimeter_needle_brt.xaml";
