...
namespace GadrocsWorkshop.Helios.Gauges.Falcon.OilPressure
{
	...
	public class OilPressure : BaseGauge
	{
		...
		private const string _faceplateOffImage = "{HeliosFalcon}/Gauges/F-16/OilPressure/oil_faceplate_off.xaml";
		private const string _faceplateDimImage = "{HeliosFalcon}/Gauges/F-16/OilPressure/oil_faceplate_dim.xaml";
		private const string _faceplateBrtImage = "{HeliosFalcon}/Gauges/F-16/OilPressure/oil_faceplate_brt.xaml";
