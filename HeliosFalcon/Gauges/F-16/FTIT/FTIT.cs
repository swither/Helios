...
namespace GadrocsWorkshop.Helios.Gauges.Falcon.FTIT
{
	...
	[HeliosControl("Helios.Falcon.FTIT", "Falcon BMS FTIT", "Falcon BMS F-16", typeof(GaugeRenderer))]
	public class FTIT : BaseGauge
	{
		...
		private const string _faceplateOffImage = "{HeliosFalcon}/Gauges/F-16/FTIT/ftit_faceplate_off.xaml";
		private const string _faceplateDimImage = "{HeliosFalcon}/Gauges/F-16/FTIT/ftit_faceplate_dim.xaml";
		private const string _faceplateBrtImage = "{HeliosFalcon}/Gauges/F-16/FTIT/ftit_faceplate_brt.xaml";
