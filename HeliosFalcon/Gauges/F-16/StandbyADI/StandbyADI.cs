...
namespace GadrocsWorkshop.Helios.Gauges.Falcon.StandbyADI
{
	...
	[HeliosControl("Helios.Falcon.StandbyADI", "Falcon BMS Standby ADI", "Falcon Simulator F-16", typeof(GaugeRenderer))]
	public class StandbyADI : BaseGauge
	{
		...
		private const string _ballOffImage = "{HeliosFalcon}/Gauges/F-16/StandbyADI/adi_ball_off.xaml";
		private const string _ballDimImage = "{HeliosFalcon}/Gauges/F-16/StandbyADI/adi_ball_dim.xaml";
		private const string _ballBrtImage = "{HeliosFalcon}/Gauges/F-16/StandbyADI/adi_ball_brt.xaml";

		private const string _ringOffImage = "{HeliosFalcon}/Gauges/F-16/StandbyADI/adi_ring_off.xaml";
		private const string _ringDimImage = "{HeliosFalcon}/Gauges/F-16/StandbyADI/adi_ring_dim.xaml";
		private const string _ringBrtImage = "{HeliosFalcon}/Gauges/F-16/StandbyADI/adi_ring_brt.xaml";

		private const string _faceplateImage = "{HeliosFalcon}/Gauges/F-16/StandbyADI/adi_faceplate.png";
		private const string _ballMaskImage = "{HeliosFalcon}/Gauges/F-16/StandbyADI/adi_ball_mask.png";
		private const string _offFlagImage = "{HeliosFalcon}/Gauges/F-16/StandbyADI/adi_off_flag.png";
