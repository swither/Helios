...
namespace GadrocsWorkshop.Helios.Gauges.Falcon.FuelFlow
{
	...
	[HeliosControl("Helios.Falcon.FuelFLow", "Falcon BMS Fuel Flow", "Falcon Simulator F-16", typeof(GaugeRenderer))]
	public class FuelFlow : BaseGauge
	{
		...
		private const string _drumTapeOffImage = "{HeliosFalcon}/Gauges/F-16/Common/drum_tape_off.xaml";
		private const string _drumTapeDimImage = "{HeliosFalcon}/Gauges/F-16/Common/drum_tape_dim.xaml";
		private const string _drumTapeBrtImage = "{HeliosFalcon}/Gauges/F-16/Common/drum_tape_brt.xaml";
		private const string _labelsOffImage = "{HeliosFalcon}/Gauges/F-16/FuelFlow/fuelflow_labels_off.xaml";
		private const string _labelsDimImage = "{HeliosFalcon}/Gauges/F-16/FuelFlow/fuelflow_labels_dim.xaml";
		private const string _labelsBrtImage = "{HeliosFalcon}/Gauges/F-16/FuelFlow/fuelflow_labels_brt.xaml";
		private const string _faceplateImage = "{HeliosFalcon}/Gauges/F-16/FuelFlow/fuelflow_bezel.png";
