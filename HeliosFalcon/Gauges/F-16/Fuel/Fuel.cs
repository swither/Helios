...
namespace GadrocsWorkshop.Helios.Gauges.Falcon.Fuel
{
	...
	[HeliosControl("Helios.Falcon.Fuel", "Falcon BMS Fuel", "Falcon BMS F-16", typeof(GaugeRenderer))]
	public class Fuel : BaseGauge
	{
		...
		private const string _faceplateOffImage = "{HeliosFalcon}/Gauges/F-16/Fuel/fuel_faceplate_off.xaml";
		private const string _faceplateDimImage = "{HeliosFalcon}/Gauges/F-16/Fuel/fuel_faceplate_dim.xaml";
		private const string _faceplateBrtImage = "{HeliosFalcon}/Gauges/F-16/Fuel/fuel_faceplate_brt.xaml";
		private const string _fuelDrumOffImage = "{HeliosFalcon}/Gauges/F-16/Common/drum_tape_off.xaml";
		private const string _fuelDrumDimImage = "{HeliosFalcon}/Gauges/F-16/Common/drum_tape_dim.xaml";
		private const string _fuelDrumBrtImage = "{HeliosFalcon}/Gauges/F-16/Common/drum_tape_brt.xaml";
		private const string _needleV1AftOffImage = "{HeliosFalcon}/Gauges/F-16/Fuel/fuel_needle_v1_aft_off.xaml";
		private const string _needleV1AftDimImage = "{HeliosFalcon}/Gauges/F-16/Fuel/fuel_needle_v1_aft_dim.xaml";
		private const string _needleV1AftBrtImage = "{HeliosFalcon}/Gauges/F-16/Fuel/fuel_needle_v1_aft_brt.xaml";
		private const string _needleV1FwdOffImage = "{HeliosFalcon}/Gauges/F-16/Fuel/fuel_needle_v1_fwd_off.xaml";
		private const string _needleV1FwdDimImage = "{HeliosFalcon}/Gauges/F-16/Fuel/fuel_needle_v1_fwd_dim.xaml";
		private const string _needleV1FwdBrtImage = "{HeliosFalcon}/Gauges/F-16/Fuel/fuel_needle_v1_fwd_brt.xaml";
		private const string _needleV2AftOffImage = "{HeliosFalcon}/Gauges/F-16/Fuel/fuel_needle_v2_aft_off.xaml";
		private const string _needleV2AftDimImage = "{HeliosFalcon}/Gauges/F-16/Fuel/fuel_needle_v2_aft_dim.xaml";
		private const string _needleV2AftBrtImage = "{HeliosFalcon}/Gauges/F-16/Fuel/fuel_needle_v2_aft_brt.xaml";
		private const string _needleV2FwdOffImage = "{HeliosFalcon}/Gauges/F-16/Fuel/fuel_needle_v2_fwd_off.xaml";
		private const string _needleV2FwdDimImage = "{HeliosFalcon}/Gauges/F-16/Fuel/fuel_needle_v2_fwd_dim.xaml";
		private const string _needleV2FwdBrtImage = "{HeliosFalcon}/Gauges/F-16/Fuel/fuel_needle_v2_fwd_brt.xaml";
