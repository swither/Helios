...
namespace GadrocsWorkshop.Helios.Gauges.Falcon.Airspeed
{
	...
	public class Airspeed : BaseGauge
	{
		...
		private const string _faceplateOffImage = "{HeliosFalcon}/Gauges/F-16/Airspeed/asi_faceplate_off.xaml";
		private const string _faceplateDimImage = "{HeliosFalcon}/Gauges/F-16/Airspeed/asi_faceplate_dim.xaml";
		private const string _faceplateBrtImage = "{HeliosFalcon}/Gauges/F-16/Airspeed/asi_faceplate_brt.xaml";
		private const string _machRingOffImage = "{HeliosFalcon}/Gauges/F-16/Airspeed/asi_mach_ring_off.xaml";
		private const string _machRingDimImage = "{HeliosFalcon}/Gauges/F-16/Airspeed/asi_mach_ring_dim.xaml";
		private const string _machRingBrtImage = "{HeliosFalcon}/Gauges/F-16/Airspeed/asi_mach_ring_brt.xaml";
		private const string _needleOffImage = "{HeliosFalcon}/Gauges/F-16/Airspeed/asi_needle_off.xaml";
		private const string _needleDimImage = "{HeliosFalcon}/Gauges/F-16/Airspeed/asi_needle_dim.xaml";
		private const string _needleBrtImage = "{HeliosFalcon}/Gauges/F-16/Airspeed/asi_needle_brt.xaml";
