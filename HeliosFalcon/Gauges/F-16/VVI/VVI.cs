...
namespace GadrocsWorkshop.Helios.Gauges.Falcon.VVI
{
	...
	public class VVI : BaseGauge
	{
		...
		private const string _flagImage = "{HeliosFalcon}/Gauges/F-16/VVI/vvi_off_flag.xaml";
		private const string _faceplateOffImage = "{HeliosFalcon}/Gauges/F-16/VVI/vvi_faceplate_off.xaml";
		private const string _faceplateDimImage = "{HeliosFalcon}/Gauges/F-16/VVI/vvi_faceplate_dim.xaml";
		private const string _faceplateBrtImage = "{HeliosFalcon}/Gauges/F-16/VVI/vvi_faceplate_brt.xaml";
		private const string _tapeOffImage = "{HeliosFalcon}/Gauges/F-16/VVI/vvi_tape_off.xaml";
		private const string _tapeDimImage = "{HeliosFalcon}/Gauges/F-16/VVI/vvi_tape_dim.xaml";
		private const string _tapeBrtImage = "{HeliosFalcon}/Gauges/F-16/VVI/vvi_tape_brt.xaml";
