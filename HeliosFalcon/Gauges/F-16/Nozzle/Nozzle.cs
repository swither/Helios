...
namespace GadrocsWorkshop.Helios.Gauges.Falcon.Nozzle
{
	...
	[HeliosControl("Helios.Falcon.Nozzle", "Falcon BMS Nozzle", "Falcon BMS F-16", typeof(GaugeRenderer))]
	public class Nozzle : BaseGauge
	{
		...
		private const string _faceplateOffImage = "{HeliosFalcon}/Gauges/F-16/Nozzle/nozzle_faceplate_off.xaml";
		private const string _faceplateDimImage = "{HeliosFalcon}/Gauges/F-16/Nozzle/nozzle_faceplate_dim.xaml";
		private const string _faceplateBrtImage = "{HeliosFalcon}/Gauges/F-16/Nozzle/nozzle_faceplate_brt.xaml";
