...
namespace GadrocsWorkshop.Helios.Gauges.Falcon.EPU
{
	...
	public class EPU : BaseGauge
	{
		...
		private const string _faceplateOffImage = "{HeliosFalcon}/Gauges/F-16/EPU/epu_faceplate_off.xaml";
		private const string _faceplateDimImage = "{HeliosFalcon}/Gauges/F-16/EPU/epu_faceplate_dim.xaml";
		private const string _faceplateBrtImage = "{HeliosFalcon}/Gauges/F-16/EPU/epu_faceplate_brt.xaml";
